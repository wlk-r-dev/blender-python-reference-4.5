...
bpy.msgbus.subscribe_rna(_key_ , _owner_ , _args_ , _notify_ , _options =set()_)
...
All subscribers will be cleared on file-load. Subscribers can be re-registered on load, see [`bpy.app.handlers.load_post`](bpy.app.handlers.html#bpy.app.handlers.load_post "bpy.app.handlers.load_post").
