...
from_mesh(_mesh_ , _face_normals =True_, _vertex_normals =True_, _use_shape_key =False_, _shape_key_index =0_)
...
from_object(_object_ , _depsgraph_ , _cage =False_, _face_normals =True_, _vertex_normals =True_)
...
transform(_matrix_ , _filter =None_)
...
Parameters:
  ...
  * **matrix** ([`mathutils.Matrix`](mathutils.html#mathutils.Matrix "mathutils.Matrix")) – 4x4x transform matrix.
...
`BMLayerCollection` of [`mathutils.Vector`](mathutils.html#mathutils.Vector "mathutils.Vector")
