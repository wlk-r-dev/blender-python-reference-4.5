...
Image buffer is also the structure used by [`bpy.types.Image`](bpy.types.Image.md#bpy.types.Image "bpy.types.Image") ID type to store and manipulate image data at runtime.
