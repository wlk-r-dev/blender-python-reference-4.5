...
#### Added
  ...
  * [[bpy.types.BrushCapabilitiesSculpt.has_dyntopo]]
...
#### Added
  ...
  * [[bpy.types.CompositorNodeCornerPin.interpolation]]
...
#### Added
  ...
  * [[bpy.types.CompositorNodeLensdist.distortion_type]]
...
#### Added
  ...
  * [[bpy.types.CompositorNodeScale.interpolation]]
...
#### Added
  ...
  * [[bpy.types.Event.hyper]]

  * [[bpy.types.Event.ndof_motion]]
...
#### Added
  ...
  * [[bpy.types.FileAssetSelectParams.instance_collections_on_append]]

  * [[bpy.types.FileAssetSelectParams.instance_collections_on_link]]
...
#### Added
  ...
  * [[bpy.types.GeometryNodeMeshToCurve.mode]]
...
#### Renamed
  ...
  * **is_type_point_cloud** -> [[bpy.types.GeometryNodeTree.is_mode_paint]]

  * **is_type_point_cloud** -> [[bpy.types.GeometryNodeTree.is_type_grease_pencil]]

  * **is_type_point_cloud** -> [[bpy.types.GeometryNodeTree.is_type_pointcloud]]
...
#### Added
  ...
  * [[bpy.types.GeometryNodeViewer.ui_shortcut]]
...
#### Renamed
  ...
  * **layer_filter** -> [[bpy.types.GreasePencilArrayModifier.tree_node_filter]]
...
#### Renamed
  ...
  * **layer_filter** -> [[bpy.types.GreasePencilBuildModifier.tree_node_filter]]
...
#### Renamed
  ...
  * **layer_filter** -> [[bpy.types.GreasePencilColorModifier.tree_node_filter]]
...
#### Renamed
  ...
  * **layer_filter** -> [[bpy.types.GreasePencilDashModifierData.tree_node_filter]]
...
#### Added
  ...
  * [[bpy.types.GreasePencilDrawing.set_vertex_weights]]

  * [[bpy.types.GreasePencilDrawing.vertex_group_assign]]

  * [[bpy.types.GreasePencilDrawing.vertex_group_remove]]
...
#### Renamed
  ...
  * **layer_filter** -> [[bpy.types.GreasePencilEnvelopeModifier.tree_node_filter]]
...
#### Renamed
  ...
  * **layer_filter** -> [[bpy.types.GreasePencilHookModifier.tree_node_filter]]
...
#### Renamed
  ...
  * **layer_filter** -> [[bpy.types.GreasePencilLatticeModifier.tree_node_filter]]
...
#### Renamed
  ...
  * **layer_filter** -> [[bpy.types.GreasePencilLengthModifier.tree_node_filter]]
...
#### Renamed
  ...
  * **layer_filter** -> [[bpy.types.GreasePencilMirrorModifier.tree_node_filter]]
...
#### Renamed
  ...
  * **layer_filter** -> [[bpy.types.GreasePencilMultiplyModifier.tree_node_filter]]
...
#### Renamed
  ...
  * **layer_filter** -> [[bpy.types.GreasePencilNoiseModifier.tree_node_filter]]
...
#### Renamed
  ...
  * **layer_filter** -> [[bpy.types.GreasePencilOffsetModifier.tree_node_filter]]
...
#### Renamed
  ...
  * **layer_filter** -> [[bpy.types.GreasePencilOpacityModifier.tree_node_filter]]
...
#### Added
  ...
  * [[bpy.types.GreasePencilOutlineModifier.use_layer_group_filter]]


#### Renamed

  * **layer_filter** -> [[bpy.types.GreasePencilOutlineModifier.tree_node_filter]]
...
#### Renamed
  ...
  * **layer_filter** -> [[bpy.types.GreasePencilShrinkwrapModifier.tree_node_filter]]
...
#### Renamed
  ...
  * **layer_filter** -> [[bpy.types.GreasePencilSimplifyModifier.tree_node_filter]]
...
#### Added
  ...
  * [[bpy.types.GreasePencilSmoothModifier.use_layer_group_filter]]


#### Renamed

  * **layer_filter** -> [[bpy.types.GreasePencilSmoothModifier.tree_node_filter]]
...
#### Added
  ...
  * [[bpy.types.GreasePencilSubdivModifier.use_layer_group_filter]]


#### Renamed

  * **layer_filter** -> [[bpy.types.GreasePencilSubdivModifier.tree_node_filter]]
...
#### Renamed
  ...
  * **layer_filter** -> [[bpy.types.GreasePencilTextureModifier.tree_node_filter]]
...
#### Renamed
  ...
  * **layer_filter** -> [[bpy.types.GreasePencilThickModifierData.tree_node_filter]]
...
#### Renamed
  ...
  * **layer_filter** -> [[bpy.types.GreasePencilTimeModifier.tree_node_filter]]
...
#### Renamed
  ...
  * **layer_filter** -> [[bpy.types.GreasePencilTintModifier.tree_node_filter]]
...
#### Added
  ...
  * [[bpy.types.GreasePencilWeightAngleModifier.use_layer_group_filter]]


#### Renamed

  * **layer_filter** -> [[bpy.types.GreasePencilWeightAngleModifier.tree_node_filter]]
...
#### Added
  ...
  * [[bpy.types.GreasePencilWeightProximityModifier.use_layer_group_filter]]


#### Renamed

  * **layer_filter** -> [[bpy.types.GreasePencilWeightProximityModifier.tree_node_filter]]
...
#### Function Arguments
  ...
  * [[bpy.types.KeyMapItems.new]] (idname, type, value, any, shift, ctrl, alt, oskey, hyper, key_modifier, direction, repeat, head), _was (idname, type, value, any, shift, ctrl, alt, oskey, key_modifier, direction, repeat, head)_

  * [[bpy.types.KeyMapItems.new_modal]] (propvalue, type, value, any, shift, ctrl, alt, oskey, hyper, key_modifier, direction, repeat), _was (propvalue, type, value, any, shift, ctrl, alt, oskey, key_modifier, direction, repeat)_
...
#### Function Arguments
  ...
  * [[bpy.types.Mesh.calc_smooth_groups]] (use_bitflags, use_boundary_vertices_for_bitflags), _was (use_bitflags)_
...
#### Added
  ...
  * [[bpy.types.ModifierViewerPathElem.modifier_uid]]
...
#### Added
  ...
  * [[bpy.types.NodeTreeInterfaceSocket.is_panel_toggle]]
...
#### Added
  ...
  * [[bpy.types.NodeTreeInterfaceSocketVector.dimensions]]
...
#### Added
  ...
  * [[bpy.types.NodeTreeInterfaceSocketVectorAcceleration.dimensions]]
...
#### Added
  ...
  * [[bpy.types.NodeTreeInterfaceSocketVectorDirection.dimensions]]
...
#### Added
  ...
  * [[bpy.types.NodeTreeInterfaceSocketVectorEuler.dimensions]]
...
#### Added
  ...
  * [[bpy.types.NodeTreeInterfaceSocketVectorTranslation.dimensions]]
...
#### Added
  ...
  * [[bpy.types.NodeTreeInterfaceSocketVectorVelocity.dimensions]]
...
#### Added
  ...
  * [[bpy.types.NodeTreeInterfaceSocketVectorXYZ.dimensions]]
...
#### Renamed
  ...
  * **use_sculpt_tools_tilt** -> [[bpy.types.PreferencesExperimental.use_attribute_storage_write]]

  * **use_sculpt_tools_tilt** -> [[bpy.types.PreferencesExperimental.use_bundle_and_closure_nodes]]

  * **use_sculpt_tools_tilt** -> [[bpy.types.PreferencesExperimental.use_socket_structure_type]]

  * **use_sculpt_tools_tilt** -> [[bpy.types.PreferencesExperimental.write_large_blend_file_blocks]]
...
#### Renamed
  ...
  * **ndof_view_navigate_method** -> [[bpy.types.PreferencesInput.ndof_navigation_mode]]
...
#### Added
  ...
  * [[bpy.types.PreferencesSystem.gpu_shader_workers]]

  * [[bpy.types.PreferencesSystem.shader_compilation_method]]
...
#### Added
  ...
  * [[bpy.types.PreferencesView.border_width]]
...
#### Added
  ...
  * [[bpy.types.RenderEngine.update_custom_camera]]
...
#### Added
  ...
  * [[bpy.types.RenderLayer.use_grease_pencil]]
...
#### Added
  ...
  * [[bpy.types.SpaceImageOverlay.passepartout_alpha]]

  * [[bpy.types.SpaceImageOverlay.show_render_size]]

  * [[bpy.types.SpaceImageOverlay.show_text_info]]
...
#### Renamed
  ...
  * **columns** -> [[bpy.types.SpaceSpreadsheet.tables]]

  * **display_viewer_path_collapsed** -> [[bpy.types.SpaceSpreadsheet.show_internal_attributes]]
...
#### Added
  ...
  * [[bpy.types.SpaceUVEditor.uv_face_opacity]]


#### Renamed

  * **show_texpaint** -> [[bpy.types.SpaceUVEditor.show_uv]]
...
#### Function Arguments
  ...
  * [[bpy.types.Strip.split]] (frame, split_method, ignore_connections), _was (frame, split_method)_
...
#### Function Arguments
  ...
  * [[bpy.types.StripsMeta.new_effect]] (name, type, channel, frame_start, frame_end, input1, input2), _was (name, type, channel, frame_start, frame_end, seq1, seq2)_
...
#### Function Arguments
  ...
  * [[bpy.types.StripsTopLevel.new_effect]] (name, type, channel, frame_start, frame_end, input1, input2), _was (name, type, channel, frame_start, frame_end, seq1, seq2)_
...
#### Added
  ...
  * [[bpy.types.ThemeClipEditor.preview_range]]
...
#### Added
  ...
  * [[bpy.types.ThemeNodeEditor.closure_zone]]
...
#### Function Arguments
  ...
  * [[bpy.types.USERPREF_UL_asset_libraries.draw_item]] (self, _context, layout, _data, item, _icon, _active_data, _active_propname, _index), _was (self, _context, layout, _data, item, icon, _active_data, _active_propname, _index)_
...
#### Function Arguments
  ...
  * [[bpy.types.Window.event_simulate]] (type, value, unicode, x, y, shift, ctrl, alt, oskey, hyper), _was (type, value, unicode, x, y, shift, ctrl, alt, oskey)_
