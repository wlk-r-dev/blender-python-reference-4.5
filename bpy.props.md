...
Parameters:
  ...
  * **options** (_set_ _[__str_ _]_) – Enumerator in [Property Flag Items](bpy_types_enum_items/property_flag_items.html#rna-enum-property-flag-items).

  * **override** (_set_ _[__str_ _]_) – Enumerator in [Property Override Flag Items](bpy_types_enum_items/property_override_flag_items.html#rna-enum-property-override-flag-items).

  * **tags** (_set_ _[__str_ _]_) – Enumerator of tags that are defined by parent class.

  * **subtype** (_str_) – Enumerator in [Property Subtype Number Items](bpy_types_enum_items/property_subtype_number_items.html#rna-enum-property-subtype-number-items).

  * **update** (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`bpy.types.Context`](bpy.types.Context.html#bpy.types.Context "bpy.types.Context")], None]) – Function to be called when this value is modified, This function must take 2 values (self, context) and return None. _Warning_ there are no safety checks to avoid infinite recursion.

  * **get** (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct "bpy.types.bpy_struct")], bool]) – Function to be called when this value is ‘read’, This function must take 1 value (self) and return the value of the property.

  * **set** (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct "bpy.types.bpy_struct"), bool], None]) – Function to be called when this value is ‘written’, This function must take 2 values (self, value) and return None.
...
Parameters:
  ...
  * **subtype** (_str_) – Enumerator in [Property Subtype Number Array Items](bpy_types_enum_items/property_subtype_number_array_items.html#rna-enum-property-subtype-number-array-items).
  ...
  * **get** (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct "bpy.types.bpy_struct")], Sequence[bool]]) – Function to be called when this value is ‘read’, This function must take 1 value (self) and return the value of the property.

  * **set** (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct "bpy.types.bpy_struct"), tuple[bool, …]], None]) – Function to be called when this value is ‘written’, This function must take 2 values (self, value) and return None.
...
Parameters:
  ...
  * **type** (type[[`bpy.types.PropertyGroup`](bpy.types.PropertyGroup.html#bpy.types.PropertyGroup "bpy.types.PropertyGroup")]) – A subclass of a property group.
  ...
  * **override** (_set_ _[__str_ _]_) – Enumerator in [Property Override Flag Collection Items](bpy_types_enum_items/property_override_flag_collection_items.html#rna-enum-property-override-flag-collection-items).
...
Parameters:
  ...
  * **items** (Iterable[tuple[str, str, str] | tuple[str, str, str, int] | tuple[str, str, str, int, int] | None] | Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`bpy.types.Context`](bpy.types.Context.html#bpy.types.Context "bpy.types.Context") | None], Iterable[tuple[str, str, str] | tuple[str, str, str, int] | tuple[str, str, str, int, int] | None]]) – 
...
An icon string identifier or integer icon value (e.g. returned by [`bpy.types.UILayout.icon`](bpy.types.UILayout.html#bpy.types.UILayout.icon "bpy.types.UILayout.icon"))
...
There is a known bug with using a callback, Python must keep a reference to the strings returned by the callback or Blender will misbehave or even crash.
  ...
  * **options** (_set_ _[__str_ _]_) – Enumerator in [Property Flag Enum Items](bpy_types_enum_items/property_flag_enum_items.html#rna-enum-property-flag-enum-items).
  ...
  * **get** (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct "bpy.types.bpy_struct")], int]) – Function to be called when this value is ‘read’, This function must take 1 value (self) and return the value of the property.

  * **set** (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct "bpy.types.bpy_struct"), int], None]) – Function to be called when this value is ‘written’, This function must take 2 values (self, value) and return None.
...
Parameters:
  ...
  * **unit** (_str_) – Enumerator in [Property Unit Items](bpy_types_enum_items/property_unit_items.html#rna-enum-property-unit-items).

  * **update** (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`bpy.types.Context`](bpy.types.Context.html#bpy.types.Context "bpy.types.Context")], None]) – Function to be called when this value is modified, This function must take 2 values (self, context) and return None. _Warning_ there are no safety checks to avoid infinite recursion.

  * **get** (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct "bpy.types.bpy_struct")], float]) – Function to be called when this value is ‘read’, This function must take 1 value (self) and return the value of the property.

  * **set** (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct "bpy.types.bpy_struct"), float], None]) – Function to be called when this value is ‘written’, This function must take 2 values (self, value) and return None.
...
Parameters:
  ...
  * **get** (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct "bpy.types.bpy_struct")], Sequence[float]]) – Function to be called when this value is ‘read’, This function must take 1 value (self) and return the value of the property.

  * **set** (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct "bpy.types.bpy_struct"), tuple[float, …]], None]) – Function to be called when this value is ‘written’, This function must take 2 values (self, value) and return None.
...
Parameters:
  ...
  * **get** (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct "bpy.types.bpy_struct")], Sequence[int]]) – Function to be called when this value is ‘read’, This function must take 1 value (self) and return the value of the property.

  * **set** (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct "bpy.types.bpy_struct"), tuple[int, …]], None]) – Function to be called when this value is ‘written’, This function must take 2 values (self, value) and return None.
...
Parameters:
  ...
  * **type** (type[[`bpy.types.PropertyGroup`](bpy.types.PropertyGroup.html#bpy.types.PropertyGroup "bpy.types.PropertyGroup") | [`bpy.types.ID`](bpy.types.ID.html#bpy.types.ID "bpy.types.ID")]) – A subclass of a property group or ID types.
  ...
  * **poll** (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`bpy.types.ID`](bpy.types.ID.html#bpy.types.ID "bpy.types.ID")], bool]) – 
...
Parameters:
  ...
  * **subtype** (_str_) – Enumerator in [Property Subtype String Items](bpy_types_enum_items/property_subtype_string_items.html#rna-enum-property-subtype-string-items).

  * **update** (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`bpy.types.Context`](bpy.types.Context.html#bpy.types.Context "bpy.types.Context")], None]) – Function to be called when this value is modified, This function must take 2 values (self, context) and return None. _Warning_ there are no safety checks to avoid infinite recursion.

  * **get** (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct "bpy.types.bpy_struct")], str]) – Function to be called when this value is ‘read’, This function must take 1 value (self) and return the value of the property.

  * **set** (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct "bpy.types.bpy_struct"), str], None]) – Function to be called when this value is ‘written’, This function must take 2 values (self, value) and return None.

  * **search** (Callable[[[`bpy.types.bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`bpy.types.Context`](bpy.types.Context.html#bpy.types.Context "bpy.types.Context"), str], Iterable[str | tuple[str, str]]]) – 
