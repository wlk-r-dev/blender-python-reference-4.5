...
bpy.ops.file.external_operation(_*_ , _filepath =''_, _operation ='OPEN'_)
...
bpy.ops.file.select(_*_ , _wait_to_deselect_others =False_, _mouse_x =0_, _mouse_y =0_, _extend =False_, _fill =False_, _open =True_, _deselect_all =False_, _only_activate_if_selected =False_, _pass_through =False_)
