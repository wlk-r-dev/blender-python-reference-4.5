...
bpy.ops.node.add_closure_zone(_*_ , _use_transform =False_, _settings =None_, _offset =(150.0, 0.0)_)
...
bpy.ops.node.add_foreach_geometry_element_zone(_*_ , _use_transform =False_, _settings =None_, _offset =(150.0, 0.0)_)
...
bpy.ops.node.add_node(_*_ , _use_transform =False_, _settings =None_, _type =''_, _visible_output =''_)
...
bpy.ops.node.add_repeat_zone(_*_ , _use_transform =False_, _settings =None_, _offset =(150.0, 0.0)_)
...
bpy.ops.node.add_simulation_zone(_*_ , _use_transform =False_, _settings =None_, _offset =(150.0, 0.0)_)
...
bpy.ops.node.bake_node_item_move(_*_ , _direction ='UP'_)
...
bpy.ops.node.capture_attribute_item_move(_*_ , _direction ='UP'_)
...
bpy.ops.node.closure_input_item_move(_*_ , _direction ='UP'_)
...
bpy.ops.node.closure_output_item_move(_*_ , _direction ='UP'_)
...
bpy.ops.node.combine_bundle_item_move(_*_ , _direction ='UP'_)
...
bpy.ops.node.enum_definition_item_move(_*_ , _direction ='UP'_)
...
bpy.ops.node.evaluate_closure_input_item_move(_*_ , _direction ='UP'_)
...
bpy.ops.node.evaluate_closure_output_item_move(_*_ , _direction ='UP'_)
...
bpy.ops.node.foreach_geometry_element_zone_generation_item_move(_*_ , _direction ='UP'_)
...
bpy.ops.node.foreach_geometry_element_zone_input_item_move(_*_ , _direction ='UP'_)
...
bpy.ops.node.foreach_geometry_element_zone_main_item_move(_*_ , _direction ='UP'_)
...
bpy.ops.node.format_string_item_move(_*_ , _direction ='UP'_)
...
bpy.ops.node.interface_item_new(_*_ , _item_type =''_)
...
**item_type** (_enum in_ _[__]__,__(__optional_ _)_) – Item Type, Type of the item to create
...
**file_path** (_string_ _,__(__optional_ _,__never None_ _)_) – File Path, Subpath of the output file

bpy.ops.node.output_file_move_active_socket(_*_ , _direction ='DOWN'_)
...
bpy.ops.node.repeat_zone_item_move(_*_ , _direction ='UP'_)
...
bpy.ops.node.separate_bundle_item_move(_*_ , _direction ='UP'_)
...
bpy.ops.node.simulation_zone_item_move(_*_ , _direction ='UP'_)
