...
bpy.ops.transform.seq_slide(_*_ , _value =(0.0, 0.0)_, _use_restore_handle_selection =False_, _snap =False_, _view2d_edge_pan =False_, _release_confirm =False_, _use_accurate =False_)
