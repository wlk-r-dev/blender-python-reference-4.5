...
Parameters:
  ...
  * **clear_constraints** (_boolean_ _,__(__optional_ _)_) – Clear Local Constraints, Remove all constraints from keyed object/bones. To get a correct bake with this setting Visual Keying should be enabled
...
bpy.ops.nla.click_select(_*_ , _wait_to_deselect_others =False_, _mouse_x =0_, _mouse_y =0_, _extend =False_, _deselect_all =False_)
