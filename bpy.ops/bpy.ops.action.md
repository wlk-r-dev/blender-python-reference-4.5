...
bpy.ops.action.clickselect(_*_ , _wait_to_deselect_others =False_, _mouse_x =0_, _mouse_y =0_, _extend =False_, _deselect_all =False_, _column =False_, _channel =False_)
