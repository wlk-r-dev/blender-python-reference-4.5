...
bpy.ops.mesh.faces_mirror_uv(_*_ , _direction ='POSITIVE'_, _precision =3_)
...
bpy.ops.mesh.remove_doubles(_*_ , _threshold =0.0001_, _use_unselected =False_, _use_sharp_edge_from_normals =False_)
