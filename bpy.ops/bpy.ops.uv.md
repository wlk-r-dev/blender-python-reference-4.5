...
bpy.ops.uv.align(_*_ , _axis ='ALIGN_AUTO'_)
...
**type** (enum in [Mesh Select Mode Uv Items](bpy_types_enum_items/mesh_select_mode_uv_items.html#rna-enum-mesh-select-mode-uv-items), (optional)) – Type
