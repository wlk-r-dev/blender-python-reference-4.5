...
bpy.ops.camera.preset_add(_*_ , _name =''_, _remove_name =False_, _remove_active =False_, _use_focal_length =False_)
...
bpy.ops.camera.safe_areas_preset_add(_*_ , _name =''_, _remove_name =False_, _remove_active =False_)
