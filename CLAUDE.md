...
Markdown documentation (converted from HTML) for `bpy` — Blender's Python API (version 4.5). Use this to look up classes, operators, properties, and types when building Blender scripts, addons, or automation tools.
