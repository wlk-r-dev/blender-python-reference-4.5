...
Example of using the blf module. For this module to work we need to use the GPU module [`gpu`](gpu.html#module-gpu "gpu") as well.
...
Example showing how text can be draw into an image. This can be done by binding an image buffer ([`imbuf`](imbuf.html#module-imbuf "imbuf")) to the font’s ID.
...
blf.bind_imbuf(_fontid_ , _image_ , _display_name =None_)
...
Parameters:
  ...
  * **display_name** (_str_ _|__None_) – The color management display name to use or None.
