...
subclasses — [`LightProbePlane`](bpy.types.LightProbePlane.md#bpy.types.LightProbePlane "bpy.types.LightProbePlane"), [`LightProbeSphere`](bpy.types.LightProbeSphere.md#bpy.types.LightProbeSphere "bpy.types.LightProbeSphere"), [`LightProbeVolume`](bpy.types.LightProbeVolume.md#bpy.types.LightProbeVolume "bpy.types.LightProbeVolume")
...
## References
  ...
  * [`bpy.context.lightprobe`](../../bpy.context.md#bpy.context.lightprobe "bpy.context.lightprobe")
  * [`BlendData.lightprobes`](../B/bpy.types.BlendData.md#bpy.types.BlendData.lightprobes "bpy.types.BlendData.lightprobes")

| 

  * [`BlendDataProbes.new`](../B/bpy.types.BlendDataProbes.md#bpy.types.BlendDataProbes.new "bpy.types.BlendDataProbes.new")
  * [`BlendDataProbes.remove`](../B/bpy.types.BlendDataProbes.md#bpy.types.BlendDataProbes.remove "bpy.types.BlendDataProbes.remove")
