...
subclasses — [`LightProbePlane`](bpy.types.LightProbePlane.html#bpy.types.LightProbePlane "bpy.types.LightProbePlane"), [`LightProbeSphere`](bpy.types.LightProbeSphere.html#bpy.types.LightProbeSphere "bpy.types.LightProbeSphere"), [`LightProbeVolume`](bpy.types.LightProbeVolume.html#bpy.types.LightProbeVolume "bpy.types.LightProbeVolume")
...
## References
  ...
  * [`bpy.context.lightprobe`](bpy.context.html#bpy.context.lightprobe "bpy.context.lightprobe")
  * [`BlendData.lightprobes`](bpy.types.BlendData.html#bpy.types.BlendData.lightprobes "bpy.types.BlendData.lightprobes")

| 

  * [`BlendDataProbes.new`](bpy.types.BlendDataProbes.html#bpy.types.BlendDataProbes.new "bpy.types.BlendDataProbes.new")
  * [`BlendDataProbes.remove`](bpy.types.BlendDataProbes.html#bpy.types.BlendDataProbes.remove "bpy.types.BlendDataProbes.remove")
