...
subclasses — [`AreaLight`](bpy.types.AreaLight.md#bpy.types.AreaLight "bpy.types.AreaLight"), [`PointLight`](bpy.types.PointLight.md#bpy.types.PointLight "bpy.types.PointLight"), [`SpotLight`](bpy.types.SpotLight.md#bpy.types.SpotLight "bpy.types.SpotLight"), [`SunLight`](bpy.types.SunLight.md#bpy.types.SunLight "bpy.types.SunLight")
...
## References
  ...
  * [`BlendData.lights`](bpy.types.BlendData.md#bpy.types.BlendData.lights "bpy.types.BlendData.lights")

| 

  * [`BlendDataLights.new`](bpy.types.BlendDataLights.md#bpy.types.BlendDataLights.new "bpy.types.BlendDataLights.new")
  * [`BlendDataLights.remove`](bpy.types.BlendDataLights.md#bpy.types.BlendDataLights.remove "bpy.types.BlendDataLights.remove")
