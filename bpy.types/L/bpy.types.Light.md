...
subclasses — [`AreaLight`](../A/bpy.types.AreaLight.md#bpy.types.AreaLight "bpy.types.AreaLight"), [`PointLight`](../P/bpy.types.PointLight.md#bpy.types.PointLight "bpy.types.PointLight"), [`SpotLight`](../S/bpy.types.SpotLight.md#bpy.types.SpotLight "bpy.types.SpotLight"), [`SunLight`](../S/bpy.types.SunLight.md#bpy.types.SunLight "bpy.types.SunLight")
...
[`mathutils.Color`](../../mathutils.md#mathutils.Color "mathutils.Color") of 3 items in [0, inf], default (0.0, 0.0, 0.0), (readonly)
...
**matrix_world** ([`mathutils.Matrix`](../../mathutils.md#mathutils.Matrix "mathutils.Matrix") of 4 * 4 items in [-inf, inf], (optional)) – Object to world space transformation matrix
...
## References
  ...
  * [`bpy.context.light`](../../bpy.context.md#bpy.context.light "bpy.context.light")
  * [`BlendData.lights`](../B/bpy.types.BlendData.md#bpy.types.BlendData.lights "bpy.types.BlendData.lights")

| 

  * [`BlendDataLights.new`](../B/bpy.types.BlendDataLights.md#bpy.types.BlendDataLights.new "bpy.types.BlendDataLights.new")
  * [`BlendDataLights.remove`](../B/bpy.types.BlendDataLights.md#bpy.types.BlendDataLights.remove "bpy.types.BlendDataLights.remove")
