...
[`bpy_prop_collection`](bpy.types.bpy_prop_collection.html#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`LatticePoint`](bpy.types.LatticePoint.html#bpy.types.LatticePoint "bpy.types.LatticePoint"), (readonly)
...
## References
  ...
  * [`bpy.context.lattice`](bpy.context.html#bpy.context.lattice "bpy.context.lattice")
  * [`BlendData.lattices`](bpy.types.BlendData.html#bpy.types.BlendData.lattices "bpy.types.BlendData.lattices")

| 

  * [`BlendDataLattices.new`](bpy.types.BlendDataLattices.html#bpy.types.BlendDataLattices.new "bpy.types.BlendDataLattices.new")
  * [`BlendDataLattices.remove`](bpy.types.BlendDataLattices.html#bpy.types.BlendDataLattices.remove "bpy.types.BlendDataLattices.remove")
