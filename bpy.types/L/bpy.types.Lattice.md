...
[`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`LatticePoint`](bpy.types.LatticePoint.md#bpy.types.LatticePoint "bpy.types.LatticePoint"), (readonly)
...
## References
  ...
  * [`bpy.context.lattice`](../../bpy.context.md#bpy.context.lattice "bpy.context.lattice")
  * [`BlendData.lattices`](../B/bpy.types.BlendData.md#bpy.types.BlendData.lattices "bpy.types.BlendData.lattices")

| 

  * [`BlendDataLattices.new`](../B/bpy.types.BlendDataLattices.md#bpy.types.BlendDataLattices.new "bpy.types.BlendDataLattices.new")
  * [`BlendDataLattices.remove`](../B/bpy.types.BlendDataLattices.md#bpy.types.BlendDataLattices.remove "bpy.types.BlendDataLattices.remove")
