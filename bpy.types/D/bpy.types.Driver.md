...
[`ChannelDriverVariables`](../C/bpy.types.ChannelDriverVariables.md#bpy.types.ChannelDriverVariables "bpy.types.ChannelDriverVariables") [`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`DriverVariable`](bpy.types.DriverVariable.md#bpy.types.DriverVariable "bpy.types.DriverVariable"), (readonly)
...
## References
  ...
  * [`FCurve.driver`](../F/bpy.types.FCurve.md#bpy.types.FCurve.driver "bpy.types.FCurve.driver")
