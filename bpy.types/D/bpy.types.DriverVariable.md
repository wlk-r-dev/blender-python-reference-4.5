...
[`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`DriverTarget`](bpy.types.DriverTarget.md#bpy.types.DriverTarget "bpy.types.DriverTarget"), (readonly)
...
## References
  ...
  * [`ChannelDriverVariables.new`](../C/bpy.types.ChannelDriverVariables.md#bpy.types.ChannelDriverVariables.new "bpy.types.ChannelDriverVariables.new")
  * [`ChannelDriverVariables.remove`](../C/bpy.types.ChannelDriverVariables.md#bpy.types.ChannelDriverVariables.remove "bpy.types.ChannelDriverVariables.remove")
