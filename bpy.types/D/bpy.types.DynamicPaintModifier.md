...
[`DynamicPaintBrushSettings`](bpy.types.DynamicPaintBrushSettings.md#bpy.types.DynamicPaintBrushSettings "bpy.types.DynamicPaintBrushSettings"), (readonly)
...
[`DynamicPaintCanvasSettings`](bpy.types.DynamicPaintCanvasSettings.md#bpy.types.DynamicPaintCanvasSettings "bpy.types.DynamicPaintCanvasSettings"), (readonly)
...
enum in [Prop Dynamicpaint Type Items](bpy_types_enum_items/prop_dynamicpaint_type_items.md#rna-enum-prop-dynamicpaint-type-items), default `'CANVAS'`
