...
enum in [Driver Target Rotation Mode Items](bpy_types_enum_items/driver_target_rotation_mode_items.html#rna-enum-driver-target-rotation-mode-items), default `'AUTO'`
