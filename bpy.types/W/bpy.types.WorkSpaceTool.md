...
Parameters:
  ...
  * **cursor** (enum in [Window Cursor Items](bpy_types_enum_items/window_cursor_items.html#rna-enum-window-cursor-items), (optional)) – cursor
...
[`GizmoGroupProperties`](bpy.types.GizmoGroupProperties.html#bpy.types.GizmoGroupProperties "bpy.types.GizmoGroupProperties"), (never None)
...
## References
  ...
  * [`WorkSpace.tools`](bpy.types.WorkSpace.html#bpy.types.WorkSpace.tools "bpy.types.WorkSpace.tools")
  * [`wmTools.from_space_image_mode`](bpy.types.wmTools.html#bpy.types.wmTools.from_space_image_mode "bpy.types.wmTools.from_space_image_mode")
  * [`wmTools.from_space_node`](bpy.types.wmTools.html#bpy.types.wmTools.from_space_node "bpy.types.wmTools.from_space_node")

| 

  * [`wmTools.from_space_sequencer`](bpy.types.wmTools.html#bpy.types.wmTools.from_space_sequencer "bpy.types.wmTools.from_space_sequencer")
  * [`wmTools.from_space_view3d_mode`](bpy.types.wmTools.html#bpy.types.wmTools.from_space_view3d_mode "bpy.types.wmTools.from_space_view3d_mode")
