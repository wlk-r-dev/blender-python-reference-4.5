...
[`wmOwnerIDs`](../_other/bpy.types.wmOwnerIDs.md#bpy.types.wmOwnerIDs "bpy.types.wmOwnerIDs") [`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`wmOwnerID`](../_other/bpy.types.wmOwnerID.md#bpy.types.wmOwnerID "bpy.types.wmOwnerID"), (readonly)
...
[`wmTools`](../_other/bpy.types.wmTools.md#bpy.types.wmTools "bpy.types.wmTools") [`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`WorkSpaceTool`](bpy.types.WorkSpaceTool.md#bpy.types.WorkSpaceTool "bpy.types.WorkSpaceTool"), (readonly)
