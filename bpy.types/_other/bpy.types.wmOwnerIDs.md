...
[`wmOwnerID`](bpy.types.wmOwnerID.md#bpy.types.wmOwnerID "bpy.types.wmOwnerID")
...
**owner_id** ([`wmOwnerID`](bpy.types.wmOwnerID.md#bpy.types.wmOwnerID "bpy.types.wmOwnerID"), (never None)) – Tag to remove
