...
subclasses — [`ActionKeyframeStrip`](bpy.types.ActionKeyframeStrip.md#bpy.types.ActionKeyframeStrip "bpy.types.ActionKeyframeStrip")
...
## References
  ...
  * [`ActionLayer.strips`](bpy.types.ActionLayer.md#bpy.types.ActionLayer.strips "bpy.types.ActionLayer.strips")
  * [`ActionStrips.new`](bpy.types.ActionStrips.md#bpy.types.ActionStrips.new "bpy.types.ActionStrips.new")

| 

  * [`ActionStrips.remove`](bpy.types.ActionStrips.md#bpy.types.ActionStrips.remove "bpy.types.ActionStrips.remove")
