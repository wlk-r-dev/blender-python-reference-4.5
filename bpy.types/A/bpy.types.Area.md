...
[`bpy_prop_collection`](bpy.types.bpy_prop_collection.html#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`Region`](bpy.types.Region.html#bpy.types.Region "bpy.types.Region"), (readonly)
...
[`AreaSpaces`](bpy.types.AreaSpaces.html#bpy.types.AreaSpaces "bpy.types.AreaSpaces") [`bpy_prop_collection`](bpy.types.bpy_prop_collection.html#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`Space`](bpy.types.Space.html#bpy.types.Space "bpy.types.Space"), (readonly)
...
enum in [Space Type Items](bpy_types_enum_items/space_type_items.html#rna-enum-space-type-items), default `'VIEW_3D'`
