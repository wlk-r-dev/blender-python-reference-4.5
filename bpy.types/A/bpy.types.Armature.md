...
[`ArmatureBones`](bpy.types.ArmatureBones.md#bpy.types.ArmatureBones "bpy.types.ArmatureBones") [`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`Bone`](../B/bpy.types.Bone.md#bpy.types.Bone "bpy.types.Bone"), (readonly)
...
[`BoneCollections`](../B/bpy.types.BoneCollections.md#bpy.types.BoneCollections "bpy.types.BoneCollections") [`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`BoneCollection`](../B/bpy.types.BoneCollection.md#bpy.types.BoneCollection "bpy.types.BoneCollection")
...
[`ArmatureEditBones`](bpy.types.ArmatureEditBones.md#bpy.types.ArmatureEditBones "bpy.types.ArmatureEditBones") [`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`EditBone`](../E/bpy.types.EditBone.md#bpy.types.EditBone "bpy.types.EditBone"), (readonly)
...
## References
  ...
  * [`BlendData.armatures`](../B/bpy.types.BlendData.md#bpy.types.BlendData.armatures "bpy.types.BlendData.armatures")

| 

  * [`BlendDataArmatures.new`](../B/bpy.types.BlendDataArmatures.md#bpy.types.BlendDataArmatures.new "bpy.types.BlendDataArmatures.new")
  * [`BlendDataArmatures.remove`](../B/bpy.types.BlendDataArmatures.md#bpy.types.BlendDataArmatures.remove "bpy.types.BlendDataArmatures.remove")
