...
enum in [Motionpath Bake Location Items](bpy_types_enum_items/motionpath_bake_location_items.html#rna-enum-motionpath-bake-location-items), default `'TAILS'`
...
enum in [Motionpath Range Items](bpy_types_enum_items/motionpath_range_items.html#rna-enum-motionpath-range-items), default `'SCENE'`
...
enum in [Motionpath Display Type Items](bpy_types_enum_items/motionpath_display_type_items.html#rna-enum-motionpath-display-type-items), default `'RANGE'`
