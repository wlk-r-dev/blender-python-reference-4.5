...
[`ActionStrip`](bpy.types.ActionStrip.md#bpy.types.ActionStrip "bpy.types.ActionStrip")
...
**anim_strip** ([`ActionStrip`](bpy.types.ActionStrip.md#bpy.types.ActionStrip "bpy.types.ActionStrip")) – Animation Strip, The strip to remove
