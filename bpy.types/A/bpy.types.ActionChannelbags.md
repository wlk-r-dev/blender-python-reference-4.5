...
**slot** ([`ActionSlot`](bpy.types.ActionSlot.md#bpy.types.ActionSlot "bpy.types.ActionSlot")) – Action Slot, The slot that should be animated by this channelbag
...
**channelbag** ([`ActionChannelbag`](bpy.types.ActionChannelbag.md#bpy.types.ActionChannelbag "bpy.types.ActionChannelbag")) – The channelbag to remove
