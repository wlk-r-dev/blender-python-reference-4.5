...
[`AssetTag`](bpy.types.AssetTag.md#bpy.types.AssetTag "bpy.types.AssetTag")
...
**tag** ([`AssetTag`](bpy.types.AssetTag.md#bpy.types.AssetTag "bpy.types.AssetTag"), (never None)) – Removed tag
