...
[`ArmatureConstraintTargets`](bpy.types.ArmatureConstraintTargets.md#bpy.types.ArmatureConstraintTargets "bpy.types.ArmatureConstraintTargets") [`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`ConstraintTargetBone`](../C/bpy.types.ConstraintTargetBone.md#bpy.types.ConstraintTargetBone "bpy.types.ConstraintTargetBone"), (readonly)
