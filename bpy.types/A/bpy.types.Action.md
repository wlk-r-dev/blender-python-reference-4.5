...
[`ActionFCurves`](bpy.types.ActionFCurves.md#bpy.types.ActionFCurves "bpy.types.ActionFCurves") [`bpy_prop_collection`](bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`FCurve`](bpy.types.FCurve.md#bpy.types.FCurve "bpy.types.FCurve"), (readonly)
...
[`ActionGroups`](bpy.types.ActionGroups.md#bpy.types.ActionGroups "bpy.types.ActionGroups") [`bpy_prop_collection`](bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`ActionGroup`](bpy.types.ActionGroup.md#bpy.types.ActionGroup "bpy.types.ActionGroup"), (readonly)
...
[`ActionLayers`](bpy.types.ActionLayers.md#bpy.types.ActionLayers "bpy.types.ActionLayers") [`bpy_prop_collection`](bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`ActionLayer`](bpy.types.ActionLayer.md#bpy.types.ActionLayer "bpy.types.ActionLayer"), (readonly)
...
[`ActionPoseMarkers`](bpy.types.ActionPoseMarkers.md#bpy.types.ActionPoseMarkers "bpy.types.ActionPoseMarkers") [`bpy_prop_collection`](bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`TimelineMarker`](bpy.types.TimelineMarker.md#bpy.types.TimelineMarker "bpy.types.TimelineMarker"), (readonly)
...
[`ActionSlots`](bpy.types.ActionSlots.md#bpy.types.ActionSlots "bpy.types.ActionSlots") [`bpy_prop_collection`](bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`ActionSlot`](bpy.types.ActionSlot.md#bpy.types.ActionSlot "bpy.types.ActionSlot"), (readonly)
...
Parameters:
  ...
  * **datablock** ([`ID`](bpy.types.ID.md#bpy.types.ID "bpy.types.ID"), (never None)) – The data-block animated by this action, for which to ensure the F-Curve exists. This action must already be assigned to the data-block
...
**object** ([`Object`](bpy.types.Object.md#bpy.types.Object "bpy.types.Object"), (never None)) – The reference armature object to use when flipping
...
## References
  ...
  * [`BlendDataActions.new`](bpy.types.BlendDataActions.md#bpy.types.BlendDataActions.new "bpy.types.BlendDataActions.new")
  * [`BlendDataActions.remove`](bpy.types.BlendDataActions.md#bpy.types.BlendDataActions.remove "bpy.types.BlendDataActions.remove")

| 

  * `GLTF2_filter_action.action`
  * [`NlaStrip.action`](bpy.types.NlaStrip.md#bpy.types.NlaStrip.action "bpy.types.NlaStrip.action")
  * [`NlaStrips.new`](bpy.types.NlaStrips.md#bpy.types.NlaStrips.new "bpy.types.NlaStrips.new")
  * [`Pose.apply_pose_from_action`](bpy.types.Pose.md#bpy.types.Pose.apply_pose_from_action "bpy.types.Pose.apply_pose_from_action")
  * [`Pose.backup_create`](bpy.types.Pose.md#bpy.types.Pose.backup_create "bpy.types.Pose.backup_create")
  * [`Pose.blend_pose_from_action`](bpy.types.Pose.md#bpy.types.Pose.blend_pose_from_action "bpy.types.Pose.blend_pose_from_action")
  * [`SpaceDopeSheetEditor.action`](bpy.types.SpaceDopeSheetEditor.md#bpy.types.SpaceDopeSheetEditor.action "bpy.types.SpaceDopeSheetEditor.action")
  * [`WindowManager.poselib_previous_action`](bpy.types.WindowManager.md#bpy.types.WindowManager.poselib_previous_action "bpy.types.WindowManager.poselib_previous_action")
