...
subclasses — [`NodeSocketStandard`](bpy.types.NodeSocketStandard.html#bpy.types.NodeSocketStandard "bpy.types.NodeSocketStandard")
...
[`Node`](bpy.types.Node.html#bpy.types.Node "bpy.types.Node"), (readonly)
...
enum in [Node Socket Type Items](bpy_types_enum_items/node_socket_type_items.html#rna-enum-node-socket-type-items), default `'VALUE'`
...
Parameters:
  ...
  * **node** ([`Node`](bpy.types.Node.html#bpy.types.Node "bpy.types.Node"), (never None)) – Node, Node the socket belongs to
...
## References
  ...
  * [`CompositorNodeOutputFileFileSlots.new`](bpy.types.CompositorNodeOutputFileFileSlots.html#bpy.types.CompositorNodeOutputFileFileSlots.new "bpy.types.CompositorNodeOutputFileFileSlots.new")
  * [`CompositorNodeOutputFileFileSlots.remove`](bpy.types.CompositorNodeOutputFileFileSlots.html#bpy.types.CompositorNodeOutputFileFileSlots.remove "bpy.types.CompositorNodeOutputFileFileSlots.remove")
  * [`CompositorNodeOutputFileLayerSlots.new`](bpy.types.CompositorNodeOutputFileLayerSlots.html#bpy.types.CompositorNodeOutputFileLayerSlots.new "bpy.types.CompositorNodeOutputFileLayerSlots.new")
  * [`CompositorNodeOutputFileLayerSlots.remove`](bpy.types.CompositorNodeOutputFileLayerSlots.html#bpy.types.CompositorNodeOutputFileLayerSlots.remove "bpy.types.CompositorNodeOutputFileLayerSlots.remove")
  ...
  * [`NodeInputs.new`](bpy.types.NodeInputs.html#bpy.types.NodeInputs.new "bpy.types.NodeInputs.new")
  * [`NodeInputs.remove`](bpy.types.NodeInputs.html#bpy.types.NodeInputs.remove "bpy.types.NodeInputs.remove")
  * [`NodeLink.from_socket`](bpy.types.NodeLink.html#bpy.types.NodeLink.from_socket "bpy.types.NodeLink.from_socket")
  * [`NodeLink.to_socket`](bpy.types.NodeLink.html#bpy.types.NodeLink.to_socket "bpy.types.NodeLink.to_socket")
  * [`NodeLinks.new`](bpy.types.NodeLinks.html#bpy.types.NodeLinks.new "bpy.types.NodeLinks.new")
  * [`NodeLinks.new`](bpy.types.NodeLinks.html#bpy.types.NodeLinks.new "bpy.types.NodeLinks.new")
  * [`NodeOutputs.new`](bpy.types.NodeOutputs.html#bpy.types.NodeOutputs.new "bpy.types.NodeOutputs.new")
  * [`NodeOutputs.remove`](bpy.types.NodeOutputs.html#bpy.types.NodeOutputs.remove "bpy.types.NodeOutputs.remove")
