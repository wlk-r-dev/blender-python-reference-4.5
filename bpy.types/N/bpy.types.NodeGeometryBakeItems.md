...
[`NodeGeometryBakeItem`](bpy.types.NodeGeometryBakeItem.md#bpy.types.NodeGeometryBakeItem "bpy.types.NodeGeometryBakeItem")
...
**item** ([`NodeGeometryBakeItem`](bpy.types.NodeGeometryBakeItem.md#bpy.types.NodeGeometryBakeItem "bpy.types.NodeGeometryBakeItem"), (never None)) – Item, The item to remove
