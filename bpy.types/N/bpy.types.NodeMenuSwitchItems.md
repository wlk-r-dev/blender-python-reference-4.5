...
_class _bpy.types.NodeMenuSwitchItems(_bpy_struct_)
...
**item** ([`NodeEnumItem`](bpy.types.NodeEnumItem.html#bpy.types.NodeEnumItem "bpy.types.NodeEnumItem"), (never None)) – Item, The item to remove
