...
**item** ([`ForeachGeometryElementGenerationItem`](bpy.types.ForeachGeometryElementGenerationItem.md#bpy.types.ForeachGeometryElementGenerationItem "bpy.types.ForeachGeometryElementGenerationItem"), (never None)) – Item, The item to remove
