...
[`NodeSocket`](bpy.types.NodeSocket.md#bpy.types.NodeSocket "bpy.types.NodeSocket"), (readonly)
...
| 
  ...
  * [`NodeLinks.remove`](bpy.types.NodeLinks.md#bpy.types.NodeLinks.remove "bpy.types.NodeLinks.remove")
