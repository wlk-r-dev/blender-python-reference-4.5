...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`Node`](bpy.types.Node.html#bpy.types.Node "bpy.types.Node")

subclasses — [`CompositorNode`](bpy.types.CompositorNode.html#bpy.types.CompositorNode "bpy.types.CompositorNode"), [`FunctionNode`](bpy.types.FunctionNode.html#bpy.types.FunctionNode "bpy.types.FunctionNode"), [`GeometryNode`](bpy.types.GeometryNode.html#bpy.types.GeometryNode "bpy.types.GeometryNode"), [`NodeFrame`](bpy.types.NodeFrame.html#bpy.types.NodeFrame "bpy.types.NodeFrame"), [`NodeGroup`](bpy.types.NodeGroup.html#bpy.types.NodeGroup "bpy.types.NodeGroup"), [`NodeGroupInput`](bpy.types.NodeGroupInput.html#bpy.types.NodeGroupInput "bpy.types.NodeGroupInput"), [`NodeGroupOutput`](bpy.types.NodeGroupOutput.html#bpy.types.NodeGroupOutput "bpy.types.NodeGroupOutput"), [`NodeReroute`](bpy.types.NodeReroute.html#bpy.types.NodeReroute "bpy.types.NodeReroute"), [`ShaderNode`](bpy.types.ShaderNode.html#bpy.types.ShaderNode "bpy.types.ShaderNode"), [`TextureNode`](bpy.types.TextureNode.html#bpy.types.TextureNode "bpy.types.TextureNode")
