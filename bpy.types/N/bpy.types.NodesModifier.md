...
[`NodesModifierBakes`](bpy.types.NodesModifierBakes.html#bpy.types.NodesModifierBakes "bpy.types.NodesModifierBakes") [`bpy_prop_collection`](bpy.types.bpy_prop_collection.html#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodesModifierBake`](bpy.types.NodesModifierBake.html#bpy.types.NodesModifierBake "bpy.types.NodesModifierBake"), (readonly)
...
[`bpy_prop_collection`](bpy.types.bpy_prop_collection.html#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodesModifierWarning`](bpy.types.NodesModifierWarning.html#bpy.types.NodesModifierWarning "bpy.types.NodesModifierWarning"), (readonly)
...
[`NodesModifierPanels`](bpy.types.NodesModifierPanels.html#bpy.types.NodesModifierPanels "bpy.types.NodesModifierPanels") [`bpy_prop_collection`](bpy.types.bpy_prop_collection.html#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodesModifierPanel`](bpy.types.NodesModifierPanel.html#bpy.types.NodesModifierPanel "bpy.types.NodesModifierPanel"), (readonly)
