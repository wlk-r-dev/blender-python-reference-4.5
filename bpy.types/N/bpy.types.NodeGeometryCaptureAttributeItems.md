...
**item** ([`NodeGeometryCaptureAttributeItem`](bpy.types.NodeGeometryCaptureAttributeItem.md#bpy.types.NodeGeometryCaptureAttributeItem "bpy.types.NodeGeometryCaptureAttributeItem"), (never None)) – Item, The item to remove
