...
**item** ([`SimulationStateItem`](bpy.types.SimulationStateItem.md#bpy.types.SimulationStateItem "bpy.types.SimulationStateItem"), (never None)) – Item, The item to remove
