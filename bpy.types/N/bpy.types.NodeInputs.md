...
_class _bpy.types.NodeInputs(_bpy_struct_)
...
[`NodeSocket`](bpy.types.NodeSocket.html#bpy.types.NodeSocket "bpy.types.NodeSocket")
...
**socket** ([`NodeSocket`](bpy.types.NodeSocket.html#bpy.types.NodeSocket "bpy.types.NodeSocket")) – The socket to remove
