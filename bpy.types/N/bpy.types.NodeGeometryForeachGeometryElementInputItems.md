...
**item** ([`ForeachGeometryElementInputItem`](bpy.types.ForeachGeometryElementInputItem.md#bpy.types.ForeachGeometryElementInputItem "bpy.types.ForeachGeometryElementInputItem"), (never None)) – Item, The item to remove
