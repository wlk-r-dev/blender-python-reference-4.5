...
**item** ([`ForeachGeometryElementMainItem`](bpy.types.ForeachGeometryElementMainItem.md#bpy.types.ForeachGeometryElementMainItem "bpy.types.ForeachGeometryElementMainItem"), (never None)) – Item, The item to remove
