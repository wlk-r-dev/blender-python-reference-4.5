...
[`SpaceNodeOverlay`](bpy.types.SpaceNodeOverlay.md#bpy.types.SpaceNodeOverlay "bpy.types.SpaceNodeOverlay"), (readonly, never None)
...
[`SpaceNodeEditorPath`](bpy.types.SpaceNodeEditorPath.md#bpy.types.SpaceNodeEditorPath "bpy.types.SpaceNodeEditorPath") [`bpy_prop_collection`](bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeTreePath`](bpy.types.NodeTreePath.md#bpy.types.NodeTreePath "bpy.types.NodeTreePath"), (readonly)
