...
_class _bpy.types.SpaceTextEditor(_Space_)
...
region_location_from_cursor(_line_ , _column_)
...
Parameters:
  ...
  * **line** (_int in_ _[__-inf_ _,__inf_ _]_) – Line, Line index

  * **column** (_int in_ _[__-inf_ _,__inf_ _]_) – Column, Column index
