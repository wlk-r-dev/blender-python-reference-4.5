...
## References
  ...
  * [`ObjectShaderFx.new`](bpy.types.ObjectShaderFx.md#bpy.types.ObjectShaderFx.new "bpy.types.ObjectShaderFx.new")

| 

  * [`ObjectShaderFx.remove`](bpy.types.ObjectShaderFx.md#bpy.types.ObjectShaderFx.remove "bpy.types.ObjectShaderFx.remove")
