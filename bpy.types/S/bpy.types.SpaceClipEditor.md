...
[`MovieClipUser`](bpy.types.MovieClipUser.html#bpy.types.MovieClipUser "bpy.types.MovieClipUser"), (readonly, never None)
...
enum in [Clip Editor Mode Items](bpy_types_enum_items/clip_editor_mode_items.html#rna-enum-clip-editor-mode-items), default `'TRACKING'`
...
[`MovieClipScopes`](bpy.types.MovieClipScopes.html#bpy.types.MovieClipScopes "bpy.types.MovieClipScopes"), (readonly)
