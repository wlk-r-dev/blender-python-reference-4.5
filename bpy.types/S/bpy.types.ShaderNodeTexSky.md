...
[`ColorMapping`](../C/bpy.types.ColorMapping.md#bpy.types.ColorMapping "bpy.types.ColorMapping"), (readonly, never None)
...
[`mathutils.Vector`](../../mathutils.md#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], default (0.0, 0.0, 1.0)
...
[`TexMapping`](../T/bpy.types.TexMapping.md#bpy.types.TexMapping "bpy.types.TexMapping"), (readonly, never None)
