...
## References
  ...
  * [`Area.spaces`](bpy.types.Area.md#bpy.types.Area.spaces "bpy.types.Area.spaces")
  * [`AreaSpaces.active`](bpy.types.AreaSpaces.md#bpy.types.AreaSpaces.active "bpy.types.AreaSpaces.active")

| 

  * [`Context.space_data`](bpy.types.Context.md#bpy.types.Context.space_data "bpy.types.Context.space_data")
