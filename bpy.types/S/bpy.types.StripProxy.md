...
## References
  ...
  * [`ImageStrip.proxy`](../I/bpy.types.ImageStrip.md#bpy.types.ImageStrip.proxy "bpy.types.ImageStrip.proxy")
  * [`MetaStrip.proxy`](../M/bpy.types.MetaStrip.md#bpy.types.MetaStrip.proxy "bpy.types.MetaStrip.proxy")

| 

  * [`MovieStrip.proxy`](../M/bpy.types.MovieStrip.md#bpy.types.MovieStrip.proxy "bpy.types.MovieStrip.proxy")
