...
_class _bpy.types.ShaderNodeAttribute(_ShaderNode_)
...
General type of the attribute
  ...
  * `VIEW_LAYER` View Layer – The attribute is associated with the View Layer, Scene or World that is being rendered.
