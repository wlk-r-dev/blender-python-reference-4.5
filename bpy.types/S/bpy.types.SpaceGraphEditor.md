...
[`DopeSheet`](bpy.types.DopeSheet.html#bpy.types.DopeSheet "bpy.types.DopeSheet"), (readonly)
...
enum in [Space Graph Mode Items](bpy_types_enum_items/space_graph_mode_items.html#rna-enum-space-graph-mode-items), default `'FCURVES'`
