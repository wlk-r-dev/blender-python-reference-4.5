...
_class _bpy.types.ShaderNodeMapRange(_ShaderNode_)
...
enum in [Node Map Range Items](bpy_types_enum_items/node_map_range_items.html#rna-enum-node-map-range-items), default `'LINEAR'`
