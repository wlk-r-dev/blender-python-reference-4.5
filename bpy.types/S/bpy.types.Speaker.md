...
## References
  ...
  * [`bpy.context.speaker`](../../bpy.context.md#bpy.context.speaker "bpy.context.speaker")
  * [`BlendData.speakers`](../B/bpy.types.BlendData.md#bpy.types.BlendData.speakers "bpy.types.BlendData.speakers")

| 

  * [`BlendDataSpeakers.new`](../B/bpy.types.BlendDataSpeakers.md#bpy.types.BlendDataSpeakers.new "bpy.types.BlendDataSpeakers.new")
  * [`BlendDataSpeakers.remove`](../B/bpy.types.BlendDataSpeakers.md#bpy.types.BlendDataSpeakers.remove "bpy.types.BlendDataSpeakers.remove")
