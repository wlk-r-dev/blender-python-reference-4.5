...
_class _bpy.types.ShaderNodeClamp(_ShaderNode_)
...
enum in [Node Clamp Items](bpy_types_enum_items/node_clamp_items.html#rna-enum-node-clamp-items), default `'MINMAX'`
