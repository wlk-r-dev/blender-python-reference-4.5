...
## References
  ...
  * [`BlendDataSounds.load`](bpy.types.BlendDataSounds.html#bpy.types.BlendDataSounds.load "bpy.types.BlendDataSounds.load")
  * [`BlendDataSounds.remove`](bpy.types.BlendDataSounds.html#bpy.types.BlendDataSounds.remove "bpy.types.BlendDataSounds.remove")

| 

  * [`SoundStrip.sound`](bpy.types.SoundStrip.html#bpy.types.SoundStrip.sound "bpy.types.SoundStrip.sound")
  * [`Speaker.sound`](bpy.types.Speaker.html#bpy.types.Speaker.sound "bpy.types.Speaker.sound")
