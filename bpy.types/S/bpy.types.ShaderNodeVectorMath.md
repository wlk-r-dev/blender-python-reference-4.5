...
_class _bpy.types.ShaderNodeVectorMath(_ShaderNode_)
...
enum in [Node Vec Math Items](bpy_types_enum_items/node_vec_math_items.html#rna-enum-node-vec-math-items), default `'ADD'`
