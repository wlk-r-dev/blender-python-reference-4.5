...
_class _bpy.types.ShaderNodeTexNoise(_ShaderNode_)
...
Type of the Noise texture
  ...
  * `HETERO_TERRAIN` Hetero Terrain – Similar to Hybrid Multifractal creates a heterogeneous terrain, but with the likeness of river channels.
