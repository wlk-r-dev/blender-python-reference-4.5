...
Parameters:
  ...
  * **node_tree** ([`NodeTree`](bpy.types.NodeTree.html#bpy.types.NodeTree "bpy.types.NodeTree")) – Node Tree, Node tree to append to the node editor path

  * **node** ([`Node`](bpy.types.Node.html#bpy.types.Node "bpy.types.Node"), (optional)) – Node, Group node linking to this node tree
...
## References
  ...
  * [`SpaceNodeEditor.path`](bpy.types.SpaceNodeEditor.html#bpy.types.SpaceNodeEditor.path "bpy.types.SpaceNodeEditor.path")
