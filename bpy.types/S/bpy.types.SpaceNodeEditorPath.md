...
**node_tree** ([`NodeTree`](../N/bpy.types.NodeTree.md#bpy.types.NodeTree "bpy.types.NodeTree")) – Node Tree
...
Parameters:
  ...
  * **node_tree** ([`NodeTree`](../N/bpy.types.NodeTree.md#bpy.types.NodeTree "bpy.types.NodeTree")) – Node Tree, Node tree to append to the node editor path

  * **node** ([`Node`](../N/bpy.types.Node.md#bpy.types.Node "bpy.types.Node"), (optional)) – Node, Group node linking to this node tree
