...
_class _bpy.types.SplineBezierPoints(_bpy_struct_)
...
## References
  ...
  * [`Spline.bezier_points`](bpy.types.Spline.md#bpy.types.Spline.bezier_points "bpy.types.Spline.bezier_points")
