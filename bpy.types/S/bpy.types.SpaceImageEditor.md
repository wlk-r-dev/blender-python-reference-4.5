...
[`SpaceImageOverlay`](bpy.types.SpaceImageOverlay.md#bpy.types.SpaceImageOverlay "bpy.types.SpaceImageOverlay"), (readonly, never None)
...
[`Histogram`](bpy.types.Histogram.md#bpy.types.Histogram "bpy.types.Histogram"), (readonly)
...
[`Scopes`](bpy.types.Scopes.md#bpy.types.Scopes "bpy.types.Scopes"), (readonly)
...
[`SpaceUVEditor`](bpy.types.SpaceUVEditor.md#bpy.types.SpaceUVEditor "bpy.types.SpaceUVEditor"), (readonly, never None)
