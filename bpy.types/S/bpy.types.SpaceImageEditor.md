...
enum in [Space Image Mode All Items](bpy_types_enum_items/space_image_mode_all_items.html#rna-enum-space-image-mode-all-items), default `'VIEW'`
...
[`SpaceImageOverlay`](bpy.types.SpaceImageOverlay.html#bpy.types.SpaceImageOverlay "bpy.types.SpaceImageOverlay"), (readonly, never None)
...
[`Histogram`](bpy.types.Histogram.html#bpy.types.Histogram "bpy.types.Histogram"), (readonly)
...
[`Scopes`](bpy.types.Scopes.html#bpy.types.Scopes "bpy.types.Scopes"), (readonly)
...
[`SpaceUVEditor`](bpy.types.SpaceUVEditor.html#bpy.types.SpaceUVEditor "bpy.types.SpaceUVEditor"), (readonly, never None)
