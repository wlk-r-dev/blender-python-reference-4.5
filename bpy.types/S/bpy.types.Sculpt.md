...
enum in [Symmetrize Direction Items](bpy_types_enum_items/symmetrize_direction_items.html#rna-enum-symmetrize-direction-items), default `'NEGATIVE_X'`
...
## References
  ...
  * [`ToolSettings.sculpt`](bpy.types.ToolSettings.html#bpy.types.ToolSettings.sculpt "bpy.types.ToolSettings.sculpt")
