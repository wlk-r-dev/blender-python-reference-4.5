...
Parameters:
  ...
  * **type** (enum in [Strip Modifier Type Items](bpy_types_enum_items/strip_modifier_type_items.md#rna-enum-strip-modifier-type-items)) – Modifier type to add
...
**modifier** ([`StripModifier`](bpy.types.StripModifier.md#bpy.types.StripModifier "bpy.types.StripModifier"), (never None)) – Modifier to remove
