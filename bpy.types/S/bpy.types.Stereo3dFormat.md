...
## References
  ...
  * [`Image.stereo_3d_format`](bpy.types.Image.md#bpy.types.Image.stereo_3d_format "bpy.types.Image.stereo_3d_format")
  * [`ImageStrip.stereo_3d_format`](bpy.types.ImageStrip.md#bpy.types.ImageStrip.stereo_3d_format "bpy.types.ImageStrip.stereo_3d_format")
  * [`MovieStrip.stereo_3d_format`](bpy.types.MovieStrip.md#bpy.types.MovieStrip.stereo_3d_format "bpy.types.MovieStrip.stereo_3d_format")

| 

  * [`ImageFormatSettings.stereo_3d_format`](bpy.types.ImageFormatSettings.md#bpy.types.ImageFormatSettings.stereo_3d_format "bpy.types.ImageFormatSettings.stereo_3d_format")
  * [`UILayout.template_image_stereo_3d`](bpy.types.UILayout.md#bpy.types.UILayout.template_image_stereo_3d "bpy.types.UILayout.template_image_stereo_3d")
