...
## References
  ...
  * [`Mesh.corner_normals`](bpy.types.Mesh.md#bpy.types.Mesh.corner_normals "bpy.types.Mesh.corner_normals")
  * [`Mesh.polygon_normals`](bpy.types.Mesh.md#bpy.types.Mesh.polygon_normals "bpy.types.Mesh.polygon_normals")

| 

  * [`Mesh.vertex_normals`](bpy.types.Mesh.md#bpy.types.Mesh.vertex_normals "bpy.types.Mesh.vertex_normals")
