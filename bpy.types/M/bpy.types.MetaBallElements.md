...
[`MetaElement`](bpy.types.MetaElement.md#bpy.types.MetaElement "bpy.types.MetaElement"), (readonly)
...
**type** (enum in [Metaelem Type Items](bpy_types_enum_items/metaelem_type_items.md#rna-enum-metaelem-type-items), (optional)) – Type for the new metaball element
...
**element** ([`MetaElement`](bpy.types.MetaElement.md#bpy.types.MetaElement "bpy.types.MetaElement"), (never None)) – The element to remove
