...
[`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`SequenceTimelineChannel`](../S/bpy.types.SequenceTimelineChannel.md#bpy.types.SequenceTimelineChannel "bpy.types.SequenceTimelineChannel"), (readonly)
...
[`StripsMeta`](../S/bpy.types.StripsMeta.md#bpy.types.StripsMeta "bpy.types.StripsMeta") [`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`Strip`](../S/bpy.types.Strip.md#bpy.types.Strip "bpy.types.Strip"), (readonly)
