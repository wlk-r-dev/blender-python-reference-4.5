...
[`MetaBallElements`](bpy.types.MetaBallElements.md#bpy.types.MetaBallElements "bpy.types.MetaBallElements") [`bpy_prop_collection`](bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`MetaElement`](bpy.types.MetaElement.md#bpy.types.MetaElement "bpy.types.MetaElement"), (readonly)
...
| 
  ...
  * [`BlendDataMetaBalls.new`](bpy.types.BlendDataMetaBalls.md#bpy.types.BlendDataMetaBalls.new "bpy.types.BlendDataMetaBalls.new")
  * [`BlendDataMetaBalls.remove`](bpy.types.BlendDataMetaBalls.md#bpy.types.BlendDataMetaBalls.remove "bpy.types.BlendDataMetaBalls.remove")
