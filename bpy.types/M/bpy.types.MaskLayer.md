...
[`MaskSplines`](bpy.types.MaskSplines.md#bpy.types.MaskSplines "bpy.types.MaskSplines") [`bpy_prop_collection`](bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`MaskSpline`](bpy.types.MaskSpline.md#bpy.types.MaskSpline "bpy.types.MaskSpline"), (readonly)
