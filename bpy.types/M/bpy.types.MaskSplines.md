...
[`MaskSplinePoint`](bpy.types.MaskSplinePoint.md#bpy.types.MaskSplinePoint "bpy.types.MaskSplinePoint")
...
**spline** ([`MaskSpline`](bpy.types.MaskSpline.md#bpy.types.MaskSpline "bpy.types.MaskSpline"), (never None)) – The spline to remove
