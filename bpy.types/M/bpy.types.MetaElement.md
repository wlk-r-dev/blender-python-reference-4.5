...
## References
  ...
  * [`MetaBallElements.active`](bpy.types.MetaBallElements.md#bpy.types.MetaBallElements.active "bpy.types.MetaBallElements.active")

| 

  * [`MetaBallElements.new`](bpy.types.MetaBallElements.md#bpy.types.MetaBallElements.new "bpy.types.MetaBallElements.new")
  * [`MetaBallElements.remove`](bpy.types.MetaBallElements.md#bpy.types.MetaBallElements.remove "bpy.types.MetaBallElements.remove")
