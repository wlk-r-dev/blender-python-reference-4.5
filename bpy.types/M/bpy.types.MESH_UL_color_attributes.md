...
_class _bpy.types.MESH_UL_color_attributes(_UIList_)
    

draw_item(__context_ , _layout_ , _data_ , _attribute_ , __icon_ , __active_data_ , __active_propname_ , __index_)
