...
[`MovieTrackingMarkers`](bpy.types.MovieTrackingMarkers.md#bpy.types.MovieTrackingMarkers "bpy.types.MovieTrackingMarkers") [`bpy_prop_collection`](bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`MovieTrackingMarker`](bpy.types.MovieTrackingMarker.md#bpy.types.MovieTrackingMarker "bpy.types.MovieTrackingMarker"), (readonly)
