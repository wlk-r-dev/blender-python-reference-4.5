...
_class _bpy.types.MovieTrackingDopesheet(_bpy_struct_)
...
Method to be used to sort channels in dopesheet view
  ...
  * `END` End Frame – Sort channels by last frame number.
...
## References
  ...
  * [`MovieTracking.dopesheet`](bpy.types.MovieTracking.html#bpy.types.MovieTracking.dopesheet "bpy.types.MovieTracking.dopesheet")
