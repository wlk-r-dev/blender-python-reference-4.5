...
[`MaskLayers`](bpy.types.MaskLayers.md#bpy.types.MaskLayers "bpy.types.MaskLayers") [`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`MaskLayer`](bpy.types.MaskLayer.md#bpy.types.MaskLayer "bpy.types.MaskLayer"), (readonly)
...
## References
  ...
  * [`bpy.context.edit_mask`](../../bpy.context.md#bpy.context.edit_mask "bpy.context.edit_mask")
  * [`BlendData.masks`](../B/bpy.types.BlendData.md#bpy.types.BlendData.masks "bpy.types.BlendData.masks")
  * [`BlendDataMasks.new`](../B/bpy.types.BlendDataMasks.md#bpy.types.BlendDataMasks.new "bpy.types.BlendDataMasks.new")
  * [`BlendDataMasks.remove`](../B/bpy.types.BlendDataMasks.md#bpy.types.BlendDataMasks.remove "bpy.types.BlendDataMasks.remove")
  * [`CompositorNodeMask.mask`](../C/bpy.types.CompositorNodeMask.md#bpy.types.CompositorNodeMask.mask "bpy.types.CompositorNodeMask.mask")
  * [`MaskStrip.mask`](bpy.types.MaskStrip.md#bpy.types.MaskStrip.mask "bpy.types.MaskStrip.mask")

| 

  * [`SpaceClipEditor.mask`](../S/bpy.types.SpaceClipEditor.md#bpy.types.SpaceClipEditor.mask "bpy.types.SpaceClipEditor.mask")
  * [`SpaceImageEditor.mask`](../S/bpy.types.SpaceImageEditor.md#bpy.types.SpaceImageEditor.mask "bpy.types.SpaceImageEditor.mask")
  ...
  * [`StripsMeta.new_mask`](../S/bpy.types.StripsMeta.md#bpy.types.StripsMeta.new_mask "bpy.types.StripsMeta.new_mask")
  * [`StripsTopLevel.new_mask`](../S/bpy.types.StripsTopLevel.md#bpy.types.StripsTopLevel.new_mask "bpy.types.StripsTopLevel.new_mask")
