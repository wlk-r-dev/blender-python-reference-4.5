...
_class _bpy.types.MaskSplinePoints(_bpy_struct_)
...
**point** ([`MaskSplinePoint`](bpy.types.MaskSplinePoint.html#bpy.types.MaskSplinePoint "bpy.types.MaskSplinePoint"), (never None)) – The point to remove
