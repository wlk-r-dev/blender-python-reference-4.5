...
_class _bpy.types.MovieClipProxy(_bpy_struct_)
...
timecode
  ...
  * `FREE_RUN_NO_GAPS` Record Run No Gaps – Effectively convert movie to an image sequence, ignoring incomplete or dropped frames, and changes in frame rate.
...
## References
  ...
  * [`MovieClip.proxy`](bpy.types.MovieClip.html#bpy.types.MovieClip.proxy "bpy.types.MovieClip.proxy")
