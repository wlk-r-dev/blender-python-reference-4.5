...
subclasses — [`ASSETBROWSER_UL_metadata_tags`](bpy.types.ASSETBROWSER_UL_metadata_tags.html#bpy.types.ASSETBROWSER_UL_metadata_tags "bpy.types.ASSETBROWSER_UL_metadata_tags"), [`CLIP_UL_tracking_objects`](bpy.types.CLIP_UL_tracking_objects.html#bpy.types.CLIP_UL_tracking_objects "bpy.types.CLIP_UL_tracking_objects"), [`CURVES_UL_attributes`](bpy.types.CURVES_UL_attributes.html#bpy.types.CURVES_UL_attributes "bpy.types.CURVES_UL_attributes"), [`DATA_UL_bone_collections`](bpy.types.DATA_UL_bone_collections.html#bpy.types.DATA_UL_bone_collections "bpy.types.DATA_UL_bone_collections"), [`FILEBROWSER_UL_dir`](bpy.types.FILEBROWSER_UL_dir.html#bpy.types.FILEBROWSER_UL_dir "bpy.types.FILEBROWSER_UL_dir"), [`GPENCIL_UL_annotation_layer`](bpy.types.GPENCIL_UL_annotation_layer.html#bpy.types.GPENCIL_UL_annotation_layer "bpy.types.GPENCIL_UL_annotation_layer"), [`GPENCIL_UL_layer`](bpy.types.GPENCIL_UL_layer.html#bpy.types.GPENCIL_UL_layer "bpy.types.GPENCIL_UL_layer"), [`GPENCIL_UL_masks`](bpy.types.GPENCIL_UL_masks.html#bpy.types.GPENCIL_UL_masks "bpy.types.GPENCIL_UL_masks"), [`GPENCIL_UL_matslots`](bpy.types.GPENCIL_UL_matslots.html#bpy.types.GPENCIL_UL_matslots "bpy.types.GPENCIL_UL_matslots"), [`GREASE_PENCIL_UL_attributes`](bpy.types.GREASE_PENCIL_UL_attributes.html#bpy.types.GREASE_PENCIL_UL_attributes "bpy.types.GREASE_PENCIL_UL_attributes"), [`GREASE_PENCIL_UL_masks`](bpy.types.GREASE_PENCIL_UL_masks.html#bpy.types.GREASE_PENCIL_UL_masks "bpy.types.GREASE_PENCIL_UL_masks"), [`IMAGE_UL_render_slots`](bpy.types.IMAGE_UL_render_slots.html#bpy.types.IMAGE_UL_render_slots "bpy.types.IMAGE_UL_render_slots"), [`IMAGE_UL_udim_tiles`](bpy.types.IMAGE_UL_udim_tiles.html#bpy.types.IMAGE_UL_udim_tiles "bpy.types.IMAGE_UL_udim_tiles"), [`MASK_UL_layers`](bpy.types.MASK_UL_layers.html#bpy.types.MASK_UL_layers "bpy.types.MASK_UL_layers"), [`MATERIAL_UL_matslots`](bpy.types.MATERIAL_UL_matslots.html#bpy.types.MATERIAL_UL_matslots "bpy.types.MATERIAL_UL_matslots"), [`MESH_UL_attributes`](bpy.types.MESH_UL_attributes.html#bpy.types.MESH_UL_attributes "bpy.types.MESH_UL_attributes"), [`MESH_UL_color_attributes`](bpy.types.MESH_UL_color_attributes.html#bpy.types.MESH_UL_color_attributes "bpy.types.MESH_UL_color_attributes"), [`MESH_UL_color_attributes_selector`](bpy.types.MESH_UL_color_attributes_selector.html#bpy.types.MESH_UL_color_attributes_selector "bpy.types.MESH_UL_color_attributes_selector"), [`MESH_UL_shape_keys`](bpy.types.MESH_UL_shape_keys.html#bpy.types.MESH_UL_shape_keys "bpy.types.MESH_UL_shape_keys"), [`MESH_UL_uvmaps`](bpy.types.MESH_UL_uvmaps.html#bpy.types.MESH_UL_uvmaps "bpy.types.MESH_UL_uvmaps"), [`MESH_UL_vgroups`](bpy.types.MESH_UL_vgroups.html#bpy.types.MESH_UL_vgroups "bpy.types.MESH_UL_vgroups"), [`PARTICLE_UL_particle_systems`](bpy.types.PARTICLE_UL_particle_systems.html#bpy.types.PARTICLE_UL_particle_systems "bpy.types.PARTICLE_UL_particle_systems"), [`PHYSICS_UL_dynapaint_surfaces`](bpy.types.PHYSICS_UL_dynapaint_surfaces.html#bpy.types.PHYSICS_UL_dynapaint_surfaces "bpy.types.PHYSICS_UL_dynapaint_surfaces"), [`POINTCLOUD_UL_attributes`](bpy.types.POINTCLOUD_UL_attributes.html#bpy.types.POINTCLOUD_UL_attributes "bpy.types.POINTCLOUD_UL_attributes"), [`POSE_UL_selection_set`](bpy.types.POSE_UL_selection_set.html#bpy.types.POSE_UL_selection_set "bpy.types.POSE_UL_selection_set"), [`RENDER_UL_renderviews`](bpy.types.RENDER_UL_renderviews.html#bpy.types.RENDER_UL_renderviews "bpy.types.RENDER_UL_renderviews"), [`SCENE_UL_gltf2_filter_action`](bpy.types.SCENE_UL_gltf2_filter_action.html#bpy.types.SCENE_UL_gltf2_filter_action "bpy.types.SCENE_UL_gltf2_filter_action"), [`SCENE_UL_keying_set_paths`](bpy.types.SCENE_UL_keying_set_paths.html#bpy.types.SCENE_UL_keying_set_paths "bpy.types.SCENE_UL_keying_set_paths"), [`TEXTURE_UL_texpaintslots`](bpy.types.TEXTURE_UL_texpaintslots.html#bpy.types.TEXTURE_UL_texpaintslots "bpy.types.TEXTURE_UL_texpaintslots"), [`TEXTURE_UL_texslots`](bpy.types.TEXTURE_UL_texslots.html#bpy.types.TEXTURE_UL_texslots "bpy.types.TEXTURE_UL_texslots"), [`UI_UL_list`](bpy.types.UI_UL_list.html#bpy.types.UI_UL_list "bpy.types.UI_UL_list"), [`USERPREF_UL_asset_libraries`](bpy.types.USERPREF_UL_asset_libraries.html#bpy.types.USERPREF_UL_asset_libraries "bpy.types.USERPREF_UL_asset_libraries"), [`USERPREF_UL_extension_repos`](bpy.types.USERPREF_UL_extension_repos.html#bpy.types.USERPREF_UL_extension_repos "bpy.types.USERPREF_UL_extension_repos"), [`VIEWLAYER_UL_aov`](bpy.types.VIEWLAYER_UL_aov.html#bpy.types.VIEWLAYER_UL_aov "bpy.types.VIEWLAYER_UL_aov"), [`VIEWLAYER_UL_linesets`](bpy.types.VIEWLAYER_UL_linesets.html#bpy.types.VIEWLAYER_UL_linesets "bpy.types.VIEWLAYER_UL_linesets"), [`VOLUME_UL_grids`](bpy.types.VOLUME_UL_grids.html#bpy.types.VOLUME_UL_grids "bpy.types.VOLUME_UL_grids"), [`WORKSPACE_UL_addons_items`](bpy.types.WORKSPACE_UL_addons_items.html#bpy.types.WORKSPACE_UL_addons_items "bpy.types.WORKSPACE_UL_addons_items")
...
enum in [Uilist Layout Type Items](bpy_types_enum_items/uilist_layout_type_items.html#rna-enum-uilist-layout-type-items), default `'DEFAULT'`, (readonly)
...
Parameters:
  ...
  * **layout** ([`UILayout`](bpy.types.UILayout.html#bpy.types.UILayout "bpy.types.UILayout"), (never None)) – Layout to draw the item

  * **data** ([`AnyType`](bpy.types.AnyType.html#bpy.types.AnyType "bpy.types.AnyType")) – Data from which to take Collection property

  * **item** ([`AnyType`](bpy.types.AnyType.html#bpy.types.AnyType "bpy.types.AnyType")) – Item of the collection property

  * **icon** (_int in_ _[__0_ _,__inf_ _]_) – Icon of the item in the collection

  * **active_data** ([`AnyType`](bpy.types.AnyType.html#bpy.types.AnyType "bpy.types.AnyType"), (never None)) – Data from which to take property for the active element
