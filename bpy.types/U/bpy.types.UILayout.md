...
Typically set to ‘INVOKE_REGION_WIN’, except some cases in [`bpy.types.Menu`](bpy.types.Menu.html#bpy.types.Menu "bpy.types.Menu") when it’s set to ‘EXEC_REGION_WIN’.

Type:
    

enum in [Operator Context Items](bpy_types_enum_items/operator_context_items.html#rna-enum-operator-context-items), default `'INVOKE_DEFAULT'`
...
Parameters:
  ...
  * **data** ([`AnyType`](bpy.types.AnyType.html#bpy.types.AnyType "bpy.types.AnyType"), (never None)) – Data from which to take the open-state property
...
**data** ([`AnyType`](bpy.types.AnyType.html#bpy.types.AnyType "bpy.types.AnyType"), (never None)) – Data from which to take the icon
...
Parameters:
  ...
  * **icon** (enum in [Icon Items](bpy_types_enum_items/icon_items.html#rna-enum-icon-items), (optional)) – Icon, Override automatic icon of the item
...
Parameters:
  ...
  * **data_highlight** ([`AnyType`](bpy.types.AnyType.html#bpy.types.AnyType "bpy.types.AnyType"), (optional, never None)) – Data from which to take highlight property
...
prop_search(_data_ , _property_ , _search_data_ , _search_property_ , _*_ , _text =''_, _text_ctxt =''_, _translate =True_, _icon ='NONE'_, _results_are_suggestions =False_)
...
Parameters:
  ...
  * **search_data** ([`AnyType`](bpy.types.AnyType.html#bpy.types.AnyType "bpy.types.AnyType"), (never None)) – Data from which to take collection to search in
...
Parameters:
  ...
  * **space_type** (enum in [Space Type Items](bpy_types_enum_items/space_type_items.html#rna-enum-space-type-items)) – Space Type

  * **region_type** (enum in [Region Type Items](bpy_types_enum_items/region_type_items.html#rna-enum-region-type-items)) – Region Type
...
Parameters:
  ...
  * **data** ([`AnyType`](bpy.types.AnyType.html#bpy.types.AnyType "bpy.types.AnyType")) – Pointer to put in context
...
Parameters:
  ...
  * **id** ([`ID`](bpy.types.ID.html#bpy.types.ID "bpy.types.ID"), (never None)) – The data-block for which to select an Action
...
Parameters:
  ...
  * **root** ([`ID`](bpy.types.ID.html#bpy.types.ID "bpy.types.ID")) – ID-block from which path is evaluated from
...
**data** ([`Constraint`](bpy.types.Constraint.html#bpy.types.Constraint "bpy.types.Constraint"), (never None)) – Constraint data
...
Parameters:
  ...
  * **id** ([`ID`](bpy.types.ID.html#bpy.types.ID "bpy.types.ID")) – ID data-block

  * **show_buttons** (_boolean_ _,__(__optional_ _)_) – Show preview buttons?

  * **parent** ([`ID`](bpy.types.ID.html#bpy.types.ID "bpy.types.ID"), (optional)) – ID data-block

  * **slot** ([`TextureSlot`](bpy.types.TextureSlot.html#bpy.types.TextureSlot "bpy.types.TextureSlot"), (optional)) – Texture slot
...
template_curve_mapping(_data_ , _property_ , _*_ , _type ='NONE'_, _levels =False_, _brush =False_, _use_negative_slope =False_, _show_tone =False_)
...
Parameters:
  ...
  * **used_layers_data** ([`AnyType`](bpy.types.AnyType.html#bpy.types.AnyType "bpy.types.AnyType")) – Data from which to take property
...
Parameters:
  ...
  * **dataptr** ([`AnyType`](bpy.types.AnyType.html#bpy.types.AnyType "bpy.types.AnyType")) – Data from which to take the Collection property

  * **propname** (_string_ _,__(__never None_ _)_) – Identifier of the Collection property in data

  * **active_dataptr** ([`AnyType`](bpy.types.AnyType.html#bpy.types.AnyType "bpy.types.AnyType"), (never None)) – Data from which to take the integer property, index of the active item
  ...
  * **type** (enum in [Uilist Layout Type Items](bpy_types_enum_items/uilist_layout_type_items.html#rna-enum-uilist-layout-type-items), (optional)) – Type, Type of layout to use
...
template_node_asset_menu_items(_*_ , _catalog_path =''_)
    

template_node_asset_menu_items

template_modifier_asset_menu_items(_*_ , _catalog_path =''_)
...
Parameters:
  ...
  * **data** ([`AnyType`](bpy.types.AnyType.html#bpy.types.AnyType "bpy.types.AnyType")) – Data from which to take property
...
template_cache_file_procedural(_data_ , _property_)
...
template_recent_files(_*_ , _rows =5_)
...
template_asset_view(_list_id_ , _asset_library_dataptr_ , _asset_library_propname_ , _assets_dataptr_ , _assets_propname_ , _active_dataptr_ , _active_propname_ , _*_ , _filter_id_types ={}_, _display_options ={}_, _activate_operator =''_, _drag_operator =''_)
...
Parameters:
  ...
  * **asset_library_dataptr** ([`AnyType`](bpy.types.AnyType.html#bpy.types.AnyType "bpy.types.AnyType"), (never None)) – Data from which to take the active asset library property

  * **asset_library_propname** (_string_ _,__(__never None_ _)_) – Identifier of the asset library property

  * **assets_dataptr** ([`AnyType`](bpy.types.AnyType.html#bpy.types.AnyType "bpy.types.AnyType"), (never None)) – Data from which to take the asset list property
  ...
  * **filter_id_types** (_enum set in {}__,__(__optional_ _)_) – filter_id_types
...
Displaying options for the asset view
  ...
  * **activate_operator** (_string_ _,__(__optional_ _,__never None_ _)_) – Name of a custom operator to invoke when activating an item

  * **drag_operator** (_string_ _,__(__optional_ _,__never None_ _)_) – Name of a custom operator to invoke when starting to drag an item. Never invoked together with the `active_operator` (if set), it’s either the drag or the activate one


Returns:
    

activate_operator_properties, Operator properties to fill in for the custom activate operator passed to the template, [`OperatorProperties`](bpy.types.OperatorProperties.html#bpy.types.OperatorProperties "bpy.types.OperatorProperties")

drag_operator_properties, Operator properties to fill in for the custom drag operator passed to the template, [`OperatorProperties`](bpy.types.OperatorProperties.html#bpy.types.OperatorProperties "bpy.types.OperatorProperties")

Return type:
    

([`OperatorProperties`](bpy.types.OperatorProperties.html#bpy.types.OperatorProperties "bpy.types.OperatorProperties"), [`OperatorProperties`](bpy.types.OperatorProperties.html#bpy.types.OperatorProperties "bpy.types.OperatorProperties"))
...
**interface** ([`NodeTreeInterface`](bpy.types.NodeTreeInterface.html#bpy.types.NodeTreeInterface "bpy.types.NodeTreeInterface"), (never None)) – Node Tree Interface, Interface of a node tree to display
...
**node** ([`Node`](bpy.types.Node.html#bpy.types.Node "bpy.types.Node"), (never None)) – Node, Display inputs of this node
...
## References
  ...
  * [`Header.layout`](bpy.types.Header.html#bpy.types.Header.layout "bpy.types.Header.layout")
  * [`Menu.layout`](bpy.types.Menu.html#bpy.types.Menu.layout "bpy.types.Menu.layout")
...
| 
  ...
  * [`Operator.layout`](bpy.types.Operator.html#bpy.types.Operator.layout "bpy.types.Operator.layout")
  * [`Panel.layout`](bpy.types.Panel.html#bpy.types.Panel.layout "bpy.types.Panel.layout")
  * `UILayout.box`
  * `UILayout.column`
  ...
  * [`UIPieMenu.layout`](bpy.types.UIPieMenu.html#bpy.types.UIPieMenu.layout "bpy.types.UIPieMenu.layout")
  * [`UIPopover.layout`](bpy.types.UIPopover.html#bpy.types.UIPopover.layout "bpy.types.UIPopover.layout")
  * [`UIPopupMenu.layout`](bpy.types.UIPopupMenu.html#bpy.types.UIPopupMenu.layout "bpy.types.UIPopupMenu.layout")
