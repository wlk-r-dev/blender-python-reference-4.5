...
_class _bpy.types.UVProjectModifier(_Modifier_)
...
[`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`UVProjector`](bpy.types.UVProjector.md#bpy.types.UVProjector "bpy.types.UVProjector"), (readonly)
