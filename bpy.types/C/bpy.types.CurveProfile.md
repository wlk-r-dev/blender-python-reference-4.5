...
[`CurveProfilePoints`](bpy.types.CurveProfilePoints.md#bpy.types.CurveProfilePoints "bpy.types.CurveProfilePoints") [`bpy_prop_collection`](bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`CurveProfilePoint`](bpy.types.CurveProfilePoint.md#bpy.types.CurveProfilePoint "bpy.types.CurveProfilePoint"), (readonly)
...
[`bpy_prop_collection`](bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`CurveProfilePoint`](bpy.types.CurveProfilePoint.md#bpy.types.CurveProfilePoint "bpy.types.CurveProfilePoint"), (readonly)
...
## References
  ...
  * [`BevelModifier.custom_profile`](bpy.types.BevelModifier.md#bpy.types.BevelModifier.custom_profile "bpy.types.BevelModifier.custom_profile")
  * [`Curve.bevel_profile`](bpy.types.Curve.md#bpy.types.Curve.bevel_profile "bpy.types.Curve.bevel_profile")

| 

  * [`ToolSettings.custom_bevel_profile_preset`](bpy.types.ToolSettings.md#bpy.types.ToolSettings.custom_bevel_profile_preset "bpy.types.ToolSettings.custom_bevel_profile_preset")
