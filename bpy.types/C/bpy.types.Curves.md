...
[`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`CurveSlice`](bpy.types.CurveSlice.md#bpy.types.CurveSlice "bpy.types.CurveSlice"), (readonly)
...
[`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`FloatVectorValueReadOnly`](../F/bpy.types.FloatVectorValueReadOnly.md#bpy.types.FloatVectorValueReadOnly "bpy.types.FloatVectorValueReadOnly"), (readonly)
...
[`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`CurvePoint`](bpy.types.CurvePoint.md#bpy.types.CurvePoint "bpy.types.CurvePoint"), (readonly)
...
[`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`FloatVectorAttributeValue`](../F/bpy.types.FloatVectorAttributeValue.md#bpy.types.FloatVectorAttributeValue "bpy.types.FloatVectorAttributeValue"), (readonly)
...
## References
  ...
  * [`BlendData.hair_curves`](../B/bpy.types.BlendData.md#bpy.types.BlendData.hair_curves "bpy.types.BlendData.hair_curves")
  * [`BlendDataHairCurves.new`](../B/bpy.types.BlendDataHairCurves.md#bpy.types.BlendDataHairCurves.new "bpy.types.BlendDataHairCurves.new")

| 

  * [`BlendDataHairCurves.remove`](../B/bpy.types.BlendDataHairCurves.md#bpy.types.BlendDataHairCurves.remove "bpy.types.BlendDataHairCurves.remove")
