...
## References
  ...
  * [`CurveMap.points`](bpy.types.CurveMap.md#bpy.types.CurveMap.points "bpy.types.CurveMap.points")
  * [`CurveMapPoints.new`](bpy.types.CurveMapPoints.md#bpy.types.CurveMapPoints.new "bpy.types.CurveMapPoints.new")

| 

  * [`CurveMapPoints.remove`](bpy.types.CurveMapPoints.md#bpy.types.CurveMapPoints.remove "bpy.types.CurveMapPoints.remove")
