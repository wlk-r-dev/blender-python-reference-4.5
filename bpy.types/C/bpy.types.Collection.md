...
[`CollectionChildren`](bpy.types.CollectionChildren.md#bpy.types.CollectionChildren "bpy.types.CollectionChildren") [`bpy_prop_collection`](bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of `Collection`, (readonly)
...
[`bpy_prop_collection`](bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`CollectionChild`](bpy.types.CollectionChild.md#bpy.types.CollectionChild "bpy.types.CollectionChild"), (readonly)
...
[`bpy_prop_collection`](bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`CollectionObject`](bpy.types.CollectionObject.md#bpy.types.CollectionObject "bpy.types.CollectionObject"), (readonly)
...
[`bpy_prop_collection`](bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`CollectionExport`](bpy.types.CollectionExport.md#bpy.types.CollectionExport "bpy.types.CollectionExport"), (readonly)
...
[`CollectionObjects`](bpy.types.CollectionObjects.md#bpy.types.CollectionObjects "bpy.types.CollectionObjects") [`bpy_prop_collection`](bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`Object`](bpy.types.Object.md#bpy.types.Object "bpy.types.Object"), (readonly)
...
## References
  ...
  * [`BlendDataCollections.new`](bpy.types.BlendDataCollections.md#bpy.types.BlendDataCollections.new "bpy.types.BlendDataCollections.new")
  * [`BlendDataCollections.remove`](bpy.types.BlendDataCollections.md#bpy.types.BlendDataCollections.remove "bpy.types.BlendDataCollections.remove")
  * [`BooleanModifier.collection`](bpy.types.BooleanModifier.md#bpy.types.BooleanModifier.collection "bpy.types.BooleanModifier.collection")
  ...
  * [`DopeSheet.filter_collection`](bpy.types.DopeSheet.md#bpy.types.DopeSheet.filter_collection "bpy.types.DopeSheet.filter_collection")
  * [`DynamicPaintSurface.brush_collection`](bpy.types.DynamicPaintSurface.md#bpy.types.DynamicPaintSurface.brush_collection "bpy.types.DynamicPaintSurface.brush_collection")
  * [`EffectorWeights.collection`](bpy.types.EffectorWeights.md#bpy.types.EffectorWeights.collection "bpy.types.EffectorWeights.collection")
  * [`FluidDomainSettings.effector_group`](bpy.types.FluidDomainSettings.md#bpy.types.FluidDomainSettings.effector_group "bpy.types.FluidDomainSettings.effector_group")
  * [`FluidDomainSettings.fluid_group`](bpy.types.FluidDomainSettings.md#bpy.types.FluidDomainSettings.fluid_group "bpy.types.FluidDomainSettings.fluid_group")
  * [`FluidDomainSettings.force_collection`](bpy.types.FluidDomainSettings.md#bpy.types.FluidDomainSettings.force_collection "bpy.types.FluidDomainSettings.force_collection")
  * [`FreestyleLineSet.collection`](bpy.types.FreestyleLineSet.md#bpy.types.FreestyleLineSet.collection "bpy.types.FreestyleLineSet.collection")

| 

  * [`GeometryNodeInputCollection.collection`](bpy.types.GeometryNodeInputCollection.md#bpy.types.GeometryNodeInputCollection.collection "bpy.types.GeometryNodeInputCollection.collection")
  * [`GreasePencilLineartModifier.source_collection`](bpy.types.GreasePencilLineartModifier.md#bpy.types.GreasePencilLineartModifier.source_collection "bpy.types.GreasePencilLineartModifier.source_collection")
  ...
  * [`LayerCollection.collection`](bpy.types.LayerCollection.md#bpy.types.LayerCollection.collection "bpy.types.LayerCollection.collection")
  ...
  * [`NodeSocketCollection.default_value`](bpy.types.NodeSocketCollection.md#bpy.types.NodeSocketCollection.default_value "bpy.types.NodeSocketCollection.default_value")
  * [`NodeTreeInterfaceSocketCollection.default_value`](bpy.types.NodeTreeInterfaceSocketCollection.md#bpy.types.NodeTreeInterfaceSocketCollection.default_value "bpy.types.NodeTreeInterfaceSocketCollection.default_value")
  * [`ObjectLightLinking.blocker_collection`](bpy.types.ObjectLightLinking.md#bpy.types.ObjectLightLinking.blocker_collection "bpy.types.ObjectLightLinking.blocker_collection")
  * [`ObjectLightLinking.receiver_collection`](bpy.types.ObjectLightLinking.md#bpy.types.ObjectLightLinking.receiver_collection "bpy.types.ObjectLightLinking.receiver_collection")
  * [`Object.instance_collection`](bpy.types.Object.md#bpy.types.Object.instance_collection "bpy.types.Object.instance_collection")
  * [`ParticleSettings.collision_collection`](bpy.types.ParticleSettings.md#bpy.types.ParticleSettings.collision_collection "bpy.types.ParticleSettings.collision_collection")
  * [`ParticleSettings.instance_collection`](bpy.types.ParticleSettings.md#bpy.types.ParticleSettings.instance_collection "bpy.types.ParticleSettings.instance_collection")
  * [`RigidBodyWorld.collection`](bpy.types.RigidBodyWorld.md#bpy.types.RigidBodyWorld.collection "bpy.types.RigidBodyWorld.collection")
  * [`RigidBodyWorld.constraints`](bpy.types.RigidBodyWorld.md#bpy.types.RigidBodyWorld.constraints "bpy.types.RigidBodyWorld.constraints")
  * [`Scene.collection`](bpy.types.Scene.md#bpy.types.Scene.collection "bpy.types.Scene.collection")
  * [`SoftBodySettings.collision_collection`](bpy.types.SoftBodySettings.md#bpy.types.SoftBodySettings.collision_collection "bpy.types.SoftBodySettings.collision_collection")
