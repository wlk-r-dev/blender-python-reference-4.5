...
## References
  ...
  * [`CurveSlice.points`](bpy.types.CurveSlice.md#bpy.types.CurveSlice.points "bpy.types.CurveSlice.points")

| 

  * [`Curves.points`](bpy.types.Curves.md#bpy.types.Curves.points "bpy.types.Curves.points")
