...
[`CacheFileLayer`](bpy.types.CacheFileLayer.md#bpy.types.CacheFileLayer "bpy.types.CacheFileLayer")
...
**filepath** (_string_ _,__(__never None_ _)_) – File path to the archive used as a layer
...
**layer** ([`CacheFileLayer`](bpy.types.CacheFileLayer.md#bpy.types.CacheFileLayer "bpy.types.CacheFileLayer"), (never None)) – Layer to remove
