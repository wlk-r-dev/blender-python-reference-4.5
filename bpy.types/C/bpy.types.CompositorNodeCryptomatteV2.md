...
[`mathutils.Color`](../../mathutils.md#mathutils.Color "mathutils.Color") of 3 items in [-inf, inf], default (1.0, 1.0, 1.0)
...
[`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`CryptomatteEntry`](bpy.types.CryptomatteEntry.md#bpy.types.CryptomatteEntry "bpy.types.CryptomatteEntry"), (readonly)
