...
## References
  ...
  * [`ColorRampElements.new`](bpy.types.ColorRampElements.md#bpy.types.ColorRampElements.new "bpy.types.ColorRampElements.new")

| 

  * [`ColorRampElements.remove`](bpy.types.ColorRampElements.md#bpy.types.ColorRampElements.remove "bpy.types.ColorRampElements.remove")
