...
## References
  ...
  * [`CacheFile.layers`](bpy.types.CacheFile.md#bpy.types.CacheFile.layers "bpy.types.CacheFile.layers")
  * [`CacheFileLayers.active`](bpy.types.CacheFileLayers.md#bpy.types.CacheFileLayers.active "bpy.types.CacheFileLayers.active")

| 

  * [`CacheFileLayers.new`](bpy.types.CacheFileLayers.md#bpy.types.CacheFileLayers.new "bpy.types.CacheFileLayers.new")
  * [`CacheFileLayers.remove`](bpy.types.CacheFileLayers.md#bpy.types.CacheFileLayers.remove "bpy.types.CacheFileLayers.remove")
