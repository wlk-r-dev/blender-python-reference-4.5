...
[`ClothCollisionSettings`](bpy.types.ClothCollisionSettings.md#bpy.types.ClothCollisionSettings "bpy.types.ClothCollisionSettings"), (readonly, never None)
...
[`ClothSettings`](bpy.types.ClothSettings.md#bpy.types.ClothSettings "bpy.types.ClothSettings"), (readonly, never None)
...
[`ClothSolverResult`](bpy.types.ClothSolverResult.md#bpy.types.ClothSolverResult "bpy.types.ClothSolverResult"), (readonly)
...
## References
  ...
  * [`bpy.context.cloth`](../../bpy.context.md#bpy.context.cloth "bpy.context.cloth")

| 

  * [`ParticleSystem.cloth`](../P/bpy.types.ParticleSystem.md#bpy.types.ParticleSystem.cloth "bpy.types.ParticleSystem.cloth")
