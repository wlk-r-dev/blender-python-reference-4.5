...
enum in [Color Space Convert Default Items](bpy_types_enum_items/color_space_convert_default_items.html#rna-enum-color-space-convert-default-items), default `'NONE'`
