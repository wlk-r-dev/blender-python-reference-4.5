...
base classes — [`bpy_struct`](../_other/bpy.types.bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`Node`](../N/bpy.types.Node.md#bpy.types.Node "bpy.types.Node"), [`NodeInternal`](../N/bpy.types.NodeInternal.md#bpy.types.NodeInternal "bpy.types.NodeInternal"), [`CompositorNode`](bpy.types.CompositorNode.md#bpy.types.CompositorNode "bpy.types.CompositorNode")
...
string, default “”, (never None, blend relative `//` prefix supported, Supports [template expressions](https://docs.blender.org/manual/en/4.5/files/file_paths.md#path-templates))
...
[`CompositorNodeOutputFileFileSlots`](bpy.types.CompositorNodeOutputFileFileSlots.md#bpy.types.CompositorNodeOutputFileFileSlots "bpy.types.CompositorNodeOutputFileFileSlots") [`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeOutputFileSlotFile`](../N/bpy.types.NodeOutputFileSlotFile.md#bpy.types.NodeOutputFileSlotFile "bpy.types.NodeOutputFileSlotFile"), (readonly)
...
[`ImageFormatSettings`](../I/bpy.types.ImageFormatSettings.md#bpy.types.ImageFormatSettings "bpy.types.ImageFormatSettings"), (readonly)
...
[`CompositorNodeOutputFileLayerSlots`](bpy.types.CompositorNodeOutputFileLayerSlots.md#bpy.types.CompositorNodeOutputFileLayerSlots "bpy.types.CompositorNodeOutputFileLayerSlots") [`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeOutputFileSlotLayer`](../N/bpy.types.NodeOutputFileSlotLayer.md#bpy.types.NodeOutputFileSlotLayer "bpy.types.NodeOutputFileSlotLayer"), (readonly)
...
| 
  ...
  * [`CompositorNode.tag_need_exec`](bpy.types.CompositorNode.md#bpy.types.CompositorNode.tag_need_exec "bpy.types.CompositorNode.tag_need_exec")
  * `CompositorNode.poll`
  * [`CompositorNode.update`](bpy.types.CompositorNode.md#bpy.types.CompositorNode.update "bpy.types.CompositorNode.update")
  * [`CompositorNode.bl_rna_get_subclass`](bpy.types.CompositorNode.md#bpy.types.CompositorNode.bl_rna_get_subclass "bpy.types.CompositorNode.bl_rna_get_subclass")
  * [`CompositorNode.bl_rna_get_subclass_py`](bpy.types.CompositorNode.md#bpy.types.CompositorNode.bl_rna_get_subclass_py "bpy.types.CompositorNode.bl_rna_get_subclass_py")
