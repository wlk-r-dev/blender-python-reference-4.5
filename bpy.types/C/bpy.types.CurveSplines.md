...
[`Spline`](../S/bpy.types.Spline.md#bpy.types.Spline "bpy.types.Spline")
...
**spline** ([`Spline`](../S/bpy.types.Spline.md#bpy.types.Spline "bpy.types.Spline"), (never None)) – The spline to remove
