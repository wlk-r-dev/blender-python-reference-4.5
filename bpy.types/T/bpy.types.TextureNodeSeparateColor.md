...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`Node`](bpy.types.Node.html#bpy.types.Node "bpy.types.Node"), [`NodeInternal`](bpy.types.NodeInternal.html#bpy.types.NodeInternal "bpy.types.NodeInternal"), [`TextureNode`](bpy.types.TextureNode.html#bpy.types.TextureNode "bpy.types.TextureNode")

_class _bpy.types.TextureNodeSeparateColor(_TextureNode_)
...
| 
  ...
  * `TextureNode.poll`
  * [`TextureNode.bl_rna_get_subclass`](bpy.types.TextureNode.html#bpy.types.TextureNode.bl_rna_get_subclass "bpy.types.TextureNode.bl_rna_get_subclass")
  * [`TextureNode.bl_rna_get_subclass_py`](bpy.types.TextureNode.html#bpy.types.TextureNode.bl_rna_get_subclass_py "bpy.types.TextureNode.bl_rna_get_subclass_py")
