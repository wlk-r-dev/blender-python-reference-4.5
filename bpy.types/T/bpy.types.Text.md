...
[`TextLine`](bpy.types.TextLine.md#bpy.types.TextLine "bpy.types.TextLine"), (readonly, never None)
...
[`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`TextLine`](bpy.types.TextLine.md#bpy.types.TextLine "bpy.types.TextLine"), (readonly)
...
## References
  ...
  * [`bpy.context.edit_text`](../../bpy.context.md#bpy.context.edit_text "bpy.context.edit_text")
  * [`BlendData.texts`](../B/bpy.types.BlendData.md#bpy.types.BlendData.texts "bpy.types.BlendData.texts")
  * [`BlendDataTexts.load`](../B/bpy.types.BlendDataTexts.md#bpy.types.BlendDataTexts.load "bpy.types.BlendDataTexts.load")
  * [`BlendDataTexts.new`](../B/bpy.types.BlendDataTexts.md#bpy.types.BlendDataTexts.new "bpy.types.BlendDataTexts.new")
  * [`BlendDataTexts.remove`](../B/bpy.types.BlendDataTexts.md#bpy.types.BlendDataTexts.remove "bpy.types.BlendDataTexts.remove")
  * [`Camera.custom_shader`](../C/bpy.types.Camera.md#bpy.types.Camera.custom_shader "bpy.types.Camera.custom_shader")

| 

  * [`FreestyleModuleSettings.script`](../F/bpy.types.FreestyleModuleSettings.md#bpy.types.FreestyleModuleSettings.script "bpy.types.FreestyleModuleSettings.script")
  * [`NodeFrame.text`](../N/bpy.types.NodeFrame.md#bpy.types.NodeFrame.text "bpy.types.NodeFrame.text")
  * [`ShaderNodeScript.script`](../S/bpy.types.ShaderNodeScript.md#bpy.types.ShaderNodeScript.script "bpy.types.ShaderNodeScript.script")
  * [`ShaderNodeTexIES.ies`](../S/bpy.types.ShaderNodeTexIES.md#bpy.types.ShaderNodeTexIES.ies "bpy.types.ShaderNodeTexIES.ies")
  * [`SpaceTextEditor.text`](../S/bpy.types.SpaceTextEditor.md#bpy.types.SpaceTextEditor.text "bpy.types.SpaceTextEditor.text")
