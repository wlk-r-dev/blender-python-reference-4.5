...
## References
  ...
  * [`Text.current_line`](bpy.types.Text.md#bpy.types.Text.current_line "bpy.types.Text.current_line")
  * [`Text.lines`](bpy.types.Text.md#bpy.types.Text.lines "bpy.types.Text.lines")

| 

  * [`Text.select_end_line`](bpy.types.Text.md#bpy.types.Text.select_end_line "bpy.types.Text.select_end_line")
