...
Parameters:
  ...
  * **xr_session_state** ([`XrSessionState`](bpy.types.XrSessionState.md#bpy.types.XrSessionState "bpy.types.XrSessionState"), (never None)) – XR Session State
...
Parameters:
  ...
  * **actionmap** ([`XrActionMap`](bpy.types.XrActionMap.md#bpy.types.XrActionMap "bpy.types.XrActionMap"), (never None)) – Action Map, Action map to use as a reference
...
Parameters:
  ...
  * **actionmap** ([`XrActionMap`](bpy.types.XrActionMap.md#bpy.types.XrActionMap "bpy.types.XrActionMap"), (never None)) – Action Map, Removed action map
