...
[`RenderPasses`](bpy.types.RenderPasses.md#bpy.types.RenderPasses "bpy.types.RenderPasses") [`bpy_prop_collection`](bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`RenderPass`](bpy.types.RenderPass.md#bpy.types.RenderPass "bpy.types.RenderPass"), (readonly)
