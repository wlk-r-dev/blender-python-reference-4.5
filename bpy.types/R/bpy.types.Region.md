...
[`AnyType`](bpy.types.AnyType.md#bpy.types.AnyType "bpy.types.AnyType"), (readonly)
...
[`View2D`](bpy.types.View2D.md#bpy.types.View2D "bpy.types.View2D"), (readonly, never None)
...
## References
  ...
  * [`Area.regions`](bpy.types.Area.md#bpy.types.Area.regions "bpy.types.Area.regions")
  * [`Context.region`](bpy.types.Context.md#bpy.types.Context.region "bpy.types.Context.region")

| 

  * [`Context.region_popup`](bpy.types.Context.md#bpy.types.Context.region_popup "bpy.types.Context.region_popup")
