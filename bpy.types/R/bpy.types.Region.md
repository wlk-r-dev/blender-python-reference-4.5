...
[`AnyType`](bpy.types.AnyType.html#bpy.types.AnyType "bpy.types.AnyType"), (readonly)
...
[`View2D`](bpy.types.View2D.html#bpy.types.View2D "bpy.types.View2D"), (readonly, never None)
...
## References
  ...
  * [`Area.regions`](bpy.types.Area.html#bpy.types.Area.regions "bpy.types.Area.regions")
  * [`Context.region`](bpy.types.Context.html#bpy.types.Context.region "bpy.types.Context.region")

| 

  * [`Context.region_popup`](bpy.types.Context.html#bpy.types.Context.region_popup "bpy.types.Context.region_popup")
