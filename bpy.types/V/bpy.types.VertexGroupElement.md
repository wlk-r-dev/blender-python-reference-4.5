...
## References
  ...
  * [`LatticePoint.groups`](bpy.types.LatticePoint.md#bpy.types.LatticePoint.groups "bpy.types.LatticePoint.groups")

| 

  * [`MeshVertex.groups`](bpy.types.MeshVertex.md#bpy.types.MeshVertex.groups "bpy.types.MeshVertex.groups")
