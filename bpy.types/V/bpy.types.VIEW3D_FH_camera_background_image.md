...
base classes — [`bpy_struct`](bpy.types.bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`FileHandler`](bpy.types.FileHandler.md#bpy.types.FileHandler "bpy.types.FileHandler")

_class _bpy.types.VIEW3D_FH_camera_background_image(_FileHandler_)
...
## Inherited Properties
  ...
  * [`FileHandler.bl_idname`](bpy.types.FileHandler.md#bpy.types.FileHandler.bl_idname "bpy.types.FileHandler.bl_idname")
  * [`FileHandler.bl_import_operator`](bpy.types.FileHandler.md#bpy.types.FileHandler.bl_import_operator "bpy.types.FileHandler.bl_import_operator")

| 

  * [`FileHandler.bl_export_operator`](bpy.types.FileHandler.md#bpy.types.FileHandler.bl_export_operator "bpy.types.FileHandler.bl_export_operator")
  * [`FileHandler.bl_label`](bpy.types.FileHandler.md#bpy.types.FileHandler.bl_label "bpy.types.FileHandler.bl_label")
  * [`FileHandler.bl_file_extensions`](bpy.types.FileHandler.md#bpy.types.FileHandler.bl_file_extensions "bpy.types.FileHandler.bl_file_extensions")
...
| 
  ...
  * [`FileHandler.bl_rna_get_subclass`](bpy.types.FileHandler.md#bpy.types.FileHandler.bl_rna_get_subclass "bpy.types.FileHandler.bl_rna_get_subclass")
  * [`FileHandler.bl_rna_get_subclass_py`](bpy.types.FileHandler.md#bpy.types.FileHandler.bl_rna_get_subclass_py "bpy.types.FileHandler.bl_rna_get_subclass_py")
