...
[`VolumeDisplay`](bpy.types.VolumeDisplay.md#bpy.types.VolumeDisplay "bpy.types.VolumeDisplay"), (readonly)
...
[`VolumeGrids`](bpy.types.VolumeGrids.md#bpy.types.VolumeGrids "bpy.types.VolumeGrids") [`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`VolumeGrid`](bpy.types.VolumeGrid.md#bpy.types.VolumeGrid "bpy.types.VolumeGrid"), (readonly)
...
[`VolumeRender`](bpy.types.VolumeRender.md#bpy.types.VolumeRender "bpy.types.VolumeRender"), (readonly)
...
## References
  ...
  * [`bpy.context.volume`](../../bpy.context.md#bpy.context.volume "bpy.context.volume")
  * [`BlendData.volumes`](../B/bpy.types.BlendData.md#bpy.types.BlendData.volumes "bpy.types.BlendData.volumes")

| 

  * [`BlendDataVolumes.new`](../B/bpy.types.BlendDataVolumes.md#bpy.types.BlendDataVolumes.new "bpy.types.BlendDataVolumes.new")
  * [`BlendDataVolumes.remove`](../B/bpy.types.BlendDataVolumes.md#bpy.types.BlendDataVolumes.remove "bpy.types.BlendDataVolumes.remove")
