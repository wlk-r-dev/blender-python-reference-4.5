...
## References
  ...
  * [`VertexGroups.active`](bpy.types.VertexGroups.md#bpy.types.VertexGroups.active "bpy.types.VertexGroups.active")

| 

  * [`VertexGroups.new`](bpy.types.VertexGroups.md#bpy.types.VertexGroups.new "bpy.types.VertexGroups.new")
  * [`VertexGroups.remove`](bpy.types.VertexGroups.md#bpy.types.VertexGroups.remove "bpy.types.VertexGroups.remove")
