...
[`mathutils.Color`](../../mathutils.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.05, 0.05, 0.05)
...
[`StudioLight`](../S/bpy.types.StudioLight.md#bpy.types.StudioLight "bpy.types.StudioLight"), (readonly)
...
[`mathutils.Color`](../../mathutils.md#mathutils.Color "mathutils.Color") of 3 items in [0, 1], default (0.8, 0.8, 0.8)
...
## References
  ...
  * [`SceneDisplay.shading`](../S/bpy.types.SceneDisplay.md#bpy.types.SceneDisplay.shading "bpy.types.SceneDisplay.shading")
  * [`SpaceView3D.shading`](../S/bpy.types.SpaceView3D.md#bpy.types.SpaceView3D.shading "bpy.types.SpaceView3D.shading")

| 

  * [`XrSessionSettings.shading`](../X/bpy.types.XrSessionSettings.md#bpy.types.XrSessionSettings.shading "bpy.types.XrSessionSettings.shading")
