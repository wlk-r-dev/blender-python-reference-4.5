...
_class _bpy.types.VIEW3D_AST_brush_gpencil_vertex(_AssetShelf_)
...
## Inherited Properties
  ...
  * [`AssetShelf.bl_idname`](bpy.types.AssetShelf.md#bpy.types.AssetShelf.bl_idname "bpy.types.AssetShelf.bl_idname")
  * [`AssetShelf.bl_space_type`](bpy.types.AssetShelf.md#bpy.types.AssetShelf.bl_space_type "bpy.types.AssetShelf.bl_space_type")
  * [`AssetShelf.bl_options`](bpy.types.AssetShelf.md#bpy.types.AssetShelf.bl_options "bpy.types.AssetShelf.bl_options")
  * [`AssetShelf.bl_activate_operator`](bpy.types.AssetShelf.md#bpy.types.AssetShelf.bl_activate_operator "bpy.types.AssetShelf.bl_activate_operator")

| 

  * [`AssetShelf.bl_default_preview_size`](bpy.types.AssetShelf.md#bpy.types.AssetShelf.bl_default_preview_size "bpy.types.AssetShelf.bl_default_preview_size")
  * [`AssetShelf.asset_library_reference`](bpy.types.AssetShelf.md#bpy.types.AssetShelf.asset_library_reference "bpy.types.AssetShelf.asset_library_reference")
  * [`AssetShelf.show_names`](bpy.types.AssetShelf.md#bpy.types.AssetShelf.show_names "bpy.types.AssetShelf.show_names")
  * [`AssetShelf.preview_size`](bpy.types.AssetShelf.md#bpy.types.AssetShelf.preview_size "bpy.types.AssetShelf.preview_size")
  * [`AssetShelf.search_filter`](bpy.types.AssetShelf.md#bpy.types.AssetShelf.search_filter "bpy.types.AssetShelf.search_filter")
...
| 
  ...
  * [`AssetShelf.asset_poll`](bpy.types.AssetShelf.md#bpy.types.AssetShelf.asset_poll "bpy.types.AssetShelf.asset_poll")
  * [`AssetShelf.get_active_asset`](bpy.types.AssetShelf.md#bpy.types.AssetShelf.get_active_asset "bpy.types.AssetShelf.get_active_asset")
  ...
  * [`AssetShelf.bl_rna_get_subclass`](bpy.types.AssetShelf.md#bpy.types.AssetShelf.bl_rna_get_subclass "bpy.types.AssetShelf.bl_rna_get_subclass")
  * [`AssetShelf.bl_rna_get_subclass_py`](bpy.types.AssetShelf.md#bpy.types.AssetShelf.bl_rna_get_subclass_py "bpy.types.AssetShelf.bl_rna_get_subclass_py")
