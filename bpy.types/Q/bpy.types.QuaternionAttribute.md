...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`Attribute`](bpy.types.Attribute.html#bpy.types.Attribute "bpy.types.Attribute")
...
[`bpy_prop_collection`](bpy.types.bpy_prop_collection.html#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`QuaternionAttributeValue`](bpy.types.QuaternionAttributeValue.html#bpy.types.QuaternionAttributeValue "bpy.types.QuaternionAttributeValue"), (readonly)
