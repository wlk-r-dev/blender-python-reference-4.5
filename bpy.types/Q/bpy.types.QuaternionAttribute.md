...
[`bpy_prop_collection`](bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`QuaternionAttributeValue`](bpy.types.QuaternionAttributeValue.md#bpy.types.QuaternionAttributeValue "bpy.types.QuaternionAttributeValue"), (readonly)
...
## Inherited Properties
  ...
  * [`Attribute.name`](bpy.types.Attribute.md#bpy.types.Attribute.name "bpy.types.Attribute.name")
  * [`Attribute.data_type`](bpy.types.Attribute.md#bpy.types.Attribute.data_type "bpy.types.Attribute.data_type")

| 

  * [`Attribute.domain`](bpy.types.Attribute.md#bpy.types.Attribute.domain "bpy.types.Attribute.domain")
  * [`Attribute.is_internal`](bpy.types.Attribute.md#bpy.types.Attribute.is_internal "bpy.types.Attribute.is_internal")
  * [`Attribute.is_required`](bpy.types.Attribute.md#bpy.types.Attribute.is_required "bpy.types.Attribute.is_required")
...
| 
  ...
  * [`Attribute.bl_rna_get_subclass`](bpy.types.Attribute.md#bpy.types.Attribute.bl_rna_get_subclass "bpy.types.Attribute.bl_rna_get_subclass")
  * [`Attribute.bl_rna_get_subclass_py`](bpy.types.Attribute.md#bpy.types.Attribute.bl_rna_get_subclass_py "bpy.types.Attribute.bl_rna_get_subclass_py")
