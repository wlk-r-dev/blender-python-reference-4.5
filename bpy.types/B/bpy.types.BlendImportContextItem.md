...
[`BlendImportContextLibraries`](bpy.types.BlendImportContextLibraries.md#bpy.types.BlendImportContextLibraries "bpy.types.BlendImportContextLibraries") [`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`BlendImportContextLibrary`](bpy.types.BlendImportContextLibrary.md#bpy.types.BlendImportContextLibrary "bpy.types.BlendImportContextLibrary"), (readonly)
...
## References
  ...
  * [`BlendImportContext.import_items`](bpy.types.BlendImportContext.md#bpy.types.BlendImportContext.import_items "bpy.types.BlendImportContext.import_items")
