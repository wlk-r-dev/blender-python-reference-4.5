...
Parameters:
  ...
  * **object_data** ([`ID`](bpy.types.ID.md#bpy.types.ID "bpy.types.ID")) – Object data or None for an empty object
...
Parameters:
  ...
  * **object** ([`Object`](bpy.types.Object.md#bpy.types.Object "bpy.types.Object"), (never None)) – Object to remove
