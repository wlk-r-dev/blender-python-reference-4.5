...
Parameters:
  ...
  * **library** ([`Library`](bpy.types.Library.md#bpy.types.Library "bpy.types.Library"), (never None)) – Library to remove
...
Parameters:
  ...
  * **datablocks** (set[[`bpy.types.ID`](bpy.types.ID.md#bpy.types.ID "bpy.types.ID")]) – set of data-blocks.
