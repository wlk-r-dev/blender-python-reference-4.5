...
[`Volume`](../V/bpy.types.Volume.md#bpy.types.Volume "bpy.types.Volume")
...
Parameters:
  ...
  * **volume** ([`Volume`](../V/bpy.types.Volume.md#bpy.types.Volume "bpy.types.Volume"), (never None)) – Volume to remove
