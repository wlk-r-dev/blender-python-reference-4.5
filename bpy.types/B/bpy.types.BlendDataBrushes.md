...
new(_name_ , _*_ , _mode ='TEXTURE_PAINT'_)
...
Parameters:
  ...
  * **mode** (enum in [Object Mode Items](bpy_types_enum_items/object_mode_items.md#rna-enum-object-mode-items), (optional)) – Paint Mode for the new brush
...
remove(_brush_ , _*_ , _do_unlink =True_, _do_id_user =True_, _do_ui_user =True_)
...
Parameters:
  ...
  * **brush** ([`Brush`](bpy.types.Brush.md#bpy.types.Brush "bpy.types.Brush"), (never None)) – Brush to remove
...
**brush** ([`Brush`](bpy.types.Brush.md#bpy.types.Brush "bpy.types.Brush"), (never None)) – Brush
