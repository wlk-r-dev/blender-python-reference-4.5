...
remove(_text_ , _*_ , _do_unlink =True_, _do_id_user =True_, _do_ui_user =True_)
...
Parameters:
  ...
  * **text** ([`Text`](../T/bpy.types.Text.md#bpy.types.Text "bpy.types.Text"), (never None)) – Text to remove
