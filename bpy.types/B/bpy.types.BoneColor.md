...
## References
  ...
  * [`Bone.color`](bpy.types.Bone.md#bpy.types.Bone.color "bpy.types.Bone.color")
  * [`EditBone.color`](../E/bpy.types.EditBone.md#bpy.types.EditBone.color "bpy.types.EditBone.color")

| 

  * [`PoseBone.color`](../P/bpy.types.PoseBone.md#bpy.types.PoseBone.color "bpy.types.PoseBone.color")
