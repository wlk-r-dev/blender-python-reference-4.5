...
## References
  ...
  * [`EditBone.color`](bpy.types.EditBone.md#bpy.types.EditBone.color "bpy.types.EditBone.color")

| 

  * [`PoseBone.color`](bpy.types.PoseBone.md#bpy.types.PoseBone.color "bpy.types.PoseBone.color")
