...
[`BoneCollection`](bpy.types.BoneCollection.md#bpy.types.BoneCollection "bpy.types.BoneCollection")
...
Parameters:
  ...
  * **parent** ([`BoneCollection`](bpy.types.BoneCollection.md#bpy.types.BoneCollection "bpy.types.BoneCollection"), (optional)) – Parent Collection, If not None, the new bone collection becomes a child of this collection
...
**bone_collection** ([`BoneCollection`](bpy.types.BoneCollection.md#bpy.types.BoneCollection "bpy.types.BoneCollection")) – Bone Collection, The bone collection to remove
