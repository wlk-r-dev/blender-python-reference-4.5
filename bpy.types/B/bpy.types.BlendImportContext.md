...
[`BlendImportContextItems`](bpy.types.BlendImportContextItems.md#bpy.types.BlendImportContextItems "bpy.types.BlendImportContextItems") [`bpy_prop_collection`](bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`BlendImportContextItem`](bpy.types.BlendImportContextItem.md#bpy.types.BlendImportContextItem "bpy.types.BlendImportContextItem"), (readonly)
