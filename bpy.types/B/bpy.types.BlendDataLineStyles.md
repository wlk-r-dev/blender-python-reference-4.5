...
Parameters:
  ...
  * **linestyle** ([`FreestyleLineStyle`](bpy.types.FreestyleLineStyle.md#bpy.types.FreestyleLineStyle "bpy.types.FreestyleLineStyle"), (never None)) – Line style to remove
