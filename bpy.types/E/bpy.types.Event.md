...
enum in [Event Direction Items](bpy_types_enum_items/event_direction_items.html#rna-enum-event-direction-items), default `'ANY'`, (readonly)
...
[`NDOFMotionEventData`](bpy.types.NDOFMotionEventData.html#bpy.types.NDOFMotionEventData "bpy.types.NDOFMotionEventData"), (readonly)
...
enum in [Event Type Items](bpy_types_enum_items/event_type_items.html#rna-enum-event-type-items), default `'NONE'`, (readonly)
...
enum in [Event Value Items](bpy_types_enum_items/event_value_items.html#rna-enum-event-value-items), default `'NOTHING'`, (readonly)
...
[`XrEventData`](bpy.types.XrEventData.html#bpy.types.XrEventData "bpy.types.XrEventData"), (readonly)
