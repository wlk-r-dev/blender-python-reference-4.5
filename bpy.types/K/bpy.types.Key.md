...
[`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`ShapeKey`](../S/bpy.types.ShapeKey.md#bpy.types.ShapeKey "bpy.types.ShapeKey"), (readonly)
...
[`ShapeKey`](../S/bpy.types.ShapeKey.md#bpy.types.ShapeKey "bpy.types.ShapeKey"), (readonly, never None)
...
[`ID`](../I/bpy.types.ID.md#bpy.types.ID "bpy.types.ID"), (readonly, never None)
...
## References
  ...
  * [`BlendData.shape_keys`](../B/bpy.types.BlendData.md#bpy.types.BlendData.shape_keys "bpy.types.BlendData.shape_keys")
  * [`Curve.shape_keys`](../C/bpy.types.Curve.md#bpy.types.Curve.shape_keys "bpy.types.Curve.shape_keys")

| 

  * [`Lattice.shape_keys`](../L/bpy.types.Lattice.md#bpy.types.Lattice.shape_keys "bpy.types.Lattice.shape_keys")
  * [`Mesh.shape_keys`](../M/bpy.types.Mesh.md#bpy.types.Mesh.shape_keys "bpy.types.Mesh.shape_keys")
