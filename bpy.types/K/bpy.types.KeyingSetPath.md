...
enum in [Keyingset Path Grouping Items](bpy_types_enum_items/keyingset_path_grouping_items.html#rna-enum-keyingset-path-grouping-items), default `'NAMED'`
...
enum in [Id Type Items](bpy_types_enum_items/id_type_items.html#rna-enum-id-type-items), default `'OBJECT'`
...
## References
  ...
  * [`KeyingSetPaths.active`](bpy.types.KeyingSetPaths.html#bpy.types.KeyingSetPaths.active "bpy.types.KeyingSetPaths.active")

| 

  * [`KeyingSetPaths.add`](bpy.types.KeyingSetPaths.html#bpy.types.KeyingSetPaths.add "bpy.types.KeyingSetPaths.add")
  * [`KeyingSetPaths.remove`](bpy.types.KeyingSetPaths.html#bpy.types.KeyingSetPaths.remove "bpy.types.KeyingSetPaths.remove")
