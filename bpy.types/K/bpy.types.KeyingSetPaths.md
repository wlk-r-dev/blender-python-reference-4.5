...
[`KeyingSetPath`](bpy.types.KeyingSetPath.html#bpy.types.KeyingSetPath "bpy.types.KeyingSetPath")
...
Parameters:
  ...
  * **target_id** ([`ID`](bpy.types.ID.html#bpy.types.ID "bpy.types.ID")) – Target ID, ID data-block for the destination
  ...
  * **group_method** (enum in [Keyingset Path Grouping Items](bpy_types_enum_items/keyingset_path_grouping_items.html#rna-enum-keyingset-path-grouping-items), (optional)) – Grouping Method, Method used to define which Group-name to use
...
**path** ([`KeyingSetPath`](bpy.types.KeyingSetPath.html#bpy.types.KeyingSetPath "bpy.types.KeyingSetPath"), (never None)) – Path
...
## References
  ...
  * [`KeyingSet.paths`](bpy.types.KeyingSet.html#bpy.types.KeyingSet.paths "bpy.types.KeyingSet.paths")
