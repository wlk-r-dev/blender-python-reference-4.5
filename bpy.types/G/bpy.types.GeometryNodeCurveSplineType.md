...
_class _bpy.types.GeometryNodeCurveSplineType(_GeometryNode_)
...
enum in [Curves Type Items](bpy_types_enum_items/curves_type_items.html#rna-enum-curves-type-items), default `'POLY'`
