...
enum in [Attribute Domain Without Corner Items](bpy_types_enum_items/attribute_domain_without_corner_items.md#rna-enum-attribute-domain-without-corner-items), default `'POINT'`
