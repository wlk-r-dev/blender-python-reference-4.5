...
_class _bpy.types.GeometryNodeStoreNamedGrid(_GeometryNode_)
...
enum in [Volume Grid Data Type Items](bpy_types_enum_items/volume_grid_data_type_items.html#rna-enum-volume-grid-data-type-items), default `'FLOAT'`
