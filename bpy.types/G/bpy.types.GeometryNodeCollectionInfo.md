...
_class _bpy.types.GeometryNodeCollectionInfo(_GeometryNode_)
...
The transformation of the instances output. Does not affect the internal geometry
  ...
  * `RELATIVE` Relative – Bring the input collection geometry into the modified object, maintaining the relative position between the objects in the scene.
