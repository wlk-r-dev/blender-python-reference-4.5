...
[`GPencilFrame`](bpy.types.GPencilFrame.md#bpy.types.GPencilFrame "bpy.types.GPencilFrame")
...
**frame** ([`GPencilFrame`](bpy.types.GPencilFrame.md#bpy.types.GPencilFrame "bpy.types.GPencilFrame"), (never None)) – Frame, The frame to remove
...
**source** ([`GPencilFrame`](bpy.types.GPencilFrame.md#bpy.types.GPencilFrame "bpy.types.GPencilFrame"), (never None)) – Source, The source frame
