...
[`GPencilLayer`](bpy.types.GPencilLayer.md#bpy.types.GPencilLayer "bpy.types.GPencilLayer")
...
**layer** ([`GPencilLayer`](bpy.types.GPencilLayer.md#bpy.types.GPencilLayer "bpy.types.GPencilLayer"), (never None)) – The layer to remove
