...
_class _bpy.types.GeometryNodeForeachGeometryElementInput(_GeometryNode_)
...
pair_with_output(_output_node_)
...
**output_node** ([`GeometryNode`](bpy.types.GeometryNode.html#bpy.types.GeometryNode "bpy.types.GeometryNode")) – Output Node, Zone output node to pair with
