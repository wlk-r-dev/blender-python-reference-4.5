...
_class _bpy.types.GeometryNodeCurveHandleTypeSelection(_GeometryNode_)
...
enum set in [Node Geometry Curve Handle Side Items](bpy_types_enum_items/node_geometry_curve_handle_side_items.html#rna-enum-node-geometry-curve-handle-side-items), default {`'LEFT'`}
