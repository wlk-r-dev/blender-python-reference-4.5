...
_class _bpy.types.GreasePencilShrinkwrapModifier(_Modifier_)
...
enum in [Shrinkwrap Face Cull Items](bpy_types_enum_items/shrinkwrap_face_cull_items.html#rna-enum-shrinkwrap-face-cull-items), default `'OFF'`
...
enum in [Shrinkwrap Type Items](bpy_types_enum_items/shrinkwrap_type_items.html#rna-enum-shrinkwrap-type-items), default `'NEAREST_SURFACEPOINT'`
...
enum in [Modifier Shrinkwrap Mode Items](bpy_types_enum_items/modifier_shrinkwrap_mode_items.html#rna-enum-modifier-shrinkwrap-mode-items), default `'ON_SURFACE'`
