...
_class _bpy.types.GeometryNodeRaycast(_GeometryNode_)
...
Mapping from the target geometry to hit points
  ...
  * `INTERPOLATED` Interpolated – Interpolate the attribute from the corners of the hit face.

  * `NEAREST` Nearest – Use the attribute value of the closest mesh element.
