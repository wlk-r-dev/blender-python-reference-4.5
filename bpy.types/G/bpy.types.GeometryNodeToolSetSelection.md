...
enum in [Attribute Domain Point Edge Face Curve Items](bpy_types_enum_items/attribute_domain_point_edge_face_curve_items.md#rna-enum-attribute-domain-point-edge-face-curve-items), default `'POINT'`
