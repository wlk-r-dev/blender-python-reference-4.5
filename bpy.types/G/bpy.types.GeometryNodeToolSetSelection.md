...
_class _bpy.types.GeometryNodeToolSetSelection(_GeometryNode_)
...
enum in [Attribute Domain Point Edge Face Curve Items](bpy_types_enum_items/attribute_domain_point_edge_face_curve_items.html#rna-enum-attribute-domain-point-edge-face-curve-items), default `'POINT'`
...
selection_type
  ...
  * `FLOAT` Float – Store floating point selection values. For mesh geometry, stored inverted as the sculpt mode mask.
