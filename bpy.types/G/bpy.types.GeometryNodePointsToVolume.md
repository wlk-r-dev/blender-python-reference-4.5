...
_class _bpy.types.GeometryNodePointsToVolume(_GeometryNode_)
...
How the voxel size is specified
  ...
  * `VOXEL_AMOUNT` Amount – Specify the approximate number of voxels along the diagonal.

  * `VOXEL_SIZE` Size – Specify the voxel side length.
