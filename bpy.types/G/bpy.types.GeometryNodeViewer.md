...
_class _bpy.types.GeometryNodeViewer(_GeometryNode_)
...
enum in [Attribute Type Items](bpy_types_enum_items/attribute_type_items.html#rna-enum-attribute-type-items), default `'FLOAT'`
...
enum in [Attribute Domain With Auto Items](bpy_types_enum_items/attribute_domain_with_auto_items.html#rna-enum-attribute-domain-with-auto-items), default `'POINT'`
