...
enum in [Attribute Domain With Auto Items](bpy_types_enum_items/attribute_domain_with_auto_items.md#rna-enum-attribute-domain-with-auto-items), default `'POINT'`
