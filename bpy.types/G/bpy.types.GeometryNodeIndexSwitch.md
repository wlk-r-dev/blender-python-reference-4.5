...
[`NodeIndexSwitchItems`](bpy.types.NodeIndexSwitchItems.md#bpy.types.NodeIndexSwitchItems "bpy.types.NodeIndexSwitchItems") [`bpy_prop_collection`](bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`IndexSwitchItem`](bpy.types.IndexSwitchItem.md#bpy.types.IndexSwitchItem "bpy.types.IndexSwitchItem"), (readonly)
