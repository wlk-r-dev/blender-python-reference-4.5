...
[`NodeEnumItem`](bpy.types.NodeEnumItem.md#bpy.types.NodeEnumItem "bpy.types.NodeEnumItem")
...
enum in [Node Socket Data Type Items](bpy_types_enum_items/node_socket_data_type_items.md#rna-enum-node-socket-data-type-items), default `'GEOMETRY'`
...
[`NodeMenuSwitchItems`](bpy.types.NodeMenuSwitchItems.md#bpy.types.NodeMenuSwitchItems "bpy.types.NodeMenuSwitchItems") [`bpy_prop_collection`](bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeEnumItem`](bpy.types.NodeEnumItem.md#bpy.types.NodeEnumItem "bpy.types.NodeEnumItem"), (readonly)
