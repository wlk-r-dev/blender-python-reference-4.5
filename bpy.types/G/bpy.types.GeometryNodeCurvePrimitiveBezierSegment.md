...
_class _bpy.types.GeometryNodeCurvePrimitiveBezierSegment(_GeometryNode_)
...
Method used to determine control handles
  ...
  * `OFFSET` Offset – The start and end handles are offsets from the spline’s control points.
