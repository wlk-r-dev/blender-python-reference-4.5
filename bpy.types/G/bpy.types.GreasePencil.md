...
[`GreasePencilLayers`](bpy.types.GreasePencilLayers.md#bpy.types.GreasePencilLayers "bpy.types.GreasePencilLayers") [`bpy_prop_collection`](bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`GPencilLayer`](bpy.types.GPencilLayer.md#bpy.types.GPencilLayer "bpy.types.GPencilLayer"), (readonly)
...
## References
  ...
  * [`BlendData.grease_pencils`](bpy.types.BlendData.md#bpy.types.BlendData.grease_pencils "bpy.types.BlendData.grease_pencils")
  * [`BlendDataGreasePencils.new`](bpy.types.BlendDataGreasePencils.md#bpy.types.BlendDataGreasePencils.new "bpy.types.BlendDataGreasePencils.new")
  * [`BlendDataGreasePencils.remove`](bpy.types.BlendDataGreasePencils.md#bpy.types.BlendDataGreasePencils.remove "bpy.types.BlendDataGreasePencils.remove")
  * [`MovieClip.grease_pencil`](bpy.types.MovieClip.md#bpy.types.MovieClip.grease_pencil "bpy.types.MovieClip.grease_pencil")

| 

  * [`MovieTrackingTrack.grease_pencil`](bpy.types.MovieTrackingTrack.md#bpy.types.MovieTrackingTrack.grease_pencil "bpy.types.MovieTrackingTrack.grease_pencil")
  * [`NodeTree.grease_pencil`](bpy.types.NodeTree.md#bpy.types.NodeTree.grease_pencil "bpy.types.NodeTree.grease_pencil")
  * [`Scene.grease_pencil`](bpy.types.Scene.md#bpy.types.Scene.grease_pencil "bpy.types.Scene.grease_pencil")
  * [`SpaceImageEditor.grease_pencil`](bpy.types.SpaceImageEditor.md#bpy.types.SpaceImageEditor.grease_pencil "bpy.types.SpaceImageEditor.grease_pencil")
  * [`SpaceSequenceEditor.grease_pencil`](bpy.types.SpaceSequenceEditor.md#bpy.types.SpaceSequenceEditor.grease_pencil "bpy.types.SpaceSequenceEditor.grease_pencil")
