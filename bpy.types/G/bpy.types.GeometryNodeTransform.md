...
_class _bpy.types.GeometryNodeTransform(_GeometryNode_)
...
How the transformation is specified
  ...
  * `COMPONENTS` Components – Provide separate location, rotation and scale.

  * `MATRIX` Matrix – Use a transformation matrix.
