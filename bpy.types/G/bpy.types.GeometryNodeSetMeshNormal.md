...
_class _bpy.types.GeometryNodeSetMeshNormal(_GeometryNode_)
...
enum in [Attribute Domain Only Mesh No Edge Items](bpy_types_enum_items/attribute_domain_only_mesh_no_edge_items.html#rna-enum-attribute-domain-only-mesh-no-edge-items), default `'POINT'`
