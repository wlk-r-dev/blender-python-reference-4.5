...
enum in [Attribute Domain Only Mesh No Edge Items](bpy_types_enum_items/attribute_domain_only_mesh_no_edge_items.md#rna-enum-attribute-domain-only-mesh-no-edge-items), default `'POINT'`
