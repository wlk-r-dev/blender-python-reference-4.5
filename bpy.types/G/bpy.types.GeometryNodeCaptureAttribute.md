...
[`RepeatItem`](../R/bpy.types.RepeatItem.md#bpy.types.RepeatItem "bpy.types.RepeatItem")
...
[`NodeGeometryCaptureAttributeItems`](../N/bpy.types.NodeGeometryCaptureAttributeItems.md#bpy.types.NodeGeometryCaptureAttributeItems "bpy.types.NodeGeometryCaptureAttributeItems") [`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeGeometryCaptureAttributeItem`](../N/bpy.types.NodeGeometryCaptureAttributeItem.md#bpy.types.NodeGeometryCaptureAttributeItem "bpy.types.NodeGeometryCaptureAttributeItem"), (readonly)
