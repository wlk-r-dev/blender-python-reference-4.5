...
_class _bpy.types.GeometryNodeSetCurveNormal(_GeometryNode_)
...
enum in [Curve Normal Mode Items](bpy_types_enum_items/curve_normal_mode_items.html#rna-enum-curve-normal-mode-items), default `'MINIMUM_TWIST'`
