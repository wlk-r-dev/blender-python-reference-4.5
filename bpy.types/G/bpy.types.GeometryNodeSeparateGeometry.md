...
_class _bpy.types.GeometryNodeSeparateGeometry(_GeometryNode_)
...
enum in [Attribute Domain Without Corner Items](bpy_types_enum_items/attribute_domain_without_corner_items.html#rna-enum-attribute-domain-without-corner-items), default `'POINT'`
