...
_class _bpy.types.GeometryNodeGizmoLinear(_GeometryNode_)
...
enum in [Geometry Nodes Gizmo Color Items](bpy_types_enum_items/geometry_nodes_gizmo_color_items.html#rna-enum-geometry-nodes-gizmo-color-items), default `'PRIMARY'`
...
enum in [Geometry Nodes Linear Gizmo Draw Style Items](bpy_types_enum_items/geometry_nodes_linear_gizmo_draw_style_items.html#rna-enum-geometry-nodes-linear-gizmo-draw-style-items), default `'ARROW'`
