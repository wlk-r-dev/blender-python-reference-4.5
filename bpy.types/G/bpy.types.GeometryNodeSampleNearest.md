...
enum in [Attribute Domain Only Mesh Items](bpy_types_enum_items/attribute_domain_only_mesh_items.md#rna-enum-attribute-domain-only-mesh-items), default `'POINT'`
