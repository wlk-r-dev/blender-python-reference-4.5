...
_class _bpy.types.GeometryNodeSampleNearest(_GeometryNode_)
...
enum in [Attribute Domain Only Mesh Items](bpy_types_enum_items/attribute_domain_only_mesh_items.html#rna-enum-attribute-domain-only-mesh-items), default `'POINT'`
