...
[`NodeGeometryRepeatOutputItems`](bpy.types.NodeGeometryRepeatOutputItems.md#bpy.types.NodeGeometryRepeatOutputItems "bpy.types.NodeGeometryRepeatOutputItems") [`bpy_prop_collection`](bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`RepeatItem`](bpy.types.RepeatItem.md#bpy.types.RepeatItem "bpy.types.RepeatItem"), (readonly)
