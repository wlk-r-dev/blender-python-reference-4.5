...
[`NodeGeometryClosureInputItems`](bpy.types.NodeGeometryClosureInputItems.md#bpy.types.NodeGeometryClosureInputItems "bpy.types.NodeGeometryClosureInputItems") [`bpy_prop_collection`](bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeGeometryClosureInputItem`](bpy.types.NodeGeometryClosureInputItem.md#bpy.types.NodeGeometryClosureInputItem "bpy.types.NodeGeometryClosureInputItem"), (readonly)
...
[`NodeGeometryClosureOutputItems`](bpy.types.NodeGeometryClosureOutputItems.md#bpy.types.NodeGeometryClosureOutputItems "bpy.types.NodeGeometryClosureOutputItems") [`bpy_prop_collection`](bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeGeometryClosureOutputItem`](bpy.types.NodeGeometryClosureOutputItem.md#bpy.types.NodeGeometryClosureOutputItem "bpy.types.NodeGeometryClosureOutputItem"), (readonly)
