...
_class _bpy.types.GeometryNodeMeshLine(_GeometryNode_)
...
count_mode
  ...
  * `RESOLUTION` Resolution – Specify the distance between vertices.
...
mode
  ...
  * `END_POINTS` End Points – Specify the line’s start and end points.
