...
_class _bpy.types.GeometryNodeMeshToVolume(_GeometryNode_)
...
How the voxel size is specified
  ...
  * `VOXEL_AMOUNT` Amount – Desired number of voxels along one axis.

  * `VOXEL_SIZE` Size – Desired voxel side length.
