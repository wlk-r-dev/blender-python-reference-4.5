...
_class _bpy.types.GeometryNodeWarning(_GeometryNode_)
...
enum in [Node Warning Type Items](bpy_types_enum_items/node_warning_type_items.html#rna-enum-node-warning-type-items), default `'ERROR'`
