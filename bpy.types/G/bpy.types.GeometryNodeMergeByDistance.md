...
_class _bpy.types.GeometryNodeMergeByDistance(_GeometryNode_)
...
mode
  ...
  * `ALL` All – Merge all close selected points, whether or not they are connected.

  * `CONNECTED` Connected – Only merge mesh vertices along existing edges. This method can be much faster.
