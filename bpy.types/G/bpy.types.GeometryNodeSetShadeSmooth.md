...
enum in [Attribute Domain Edge Face Items](bpy_types_enum_items/attribute_domain_edge_face_items.md#rna-enum-attribute-domain-edge-face-items), default `'EDGE'`
