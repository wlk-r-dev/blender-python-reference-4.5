...
enum in [Node Geometry Mesh Circle Fill Type Items](bpy_types_enum_items/node_geometry_mesh_circle_fill_type_items.md#rna-enum-node-geometry-mesh-circle-fill-type-items), default `'NGON'`
