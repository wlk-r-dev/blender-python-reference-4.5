...
[`NodeGeometryBakeItems`](bpy.types.NodeGeometryBakeItems.md#bpy.types.NodeGeometryBakeItems "bpy.types.NodeGeometryBakeItems") [`bpy_prop_collection`](bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeGeometryBakeItem`](bpy.types.NodeGeometryBakeItem.md#bpy.types.NodeGeometryBakeItem "bpy.types.NodeGeometryBakeItem"), (readonly)
