...
[`Modifier`](bpy.types.Modifier.md#bpy.types.Modifier "bpy.types.Modifier")
...
**modifier** ([`Modifier`](bpy.types.Modifier.md#bpy.types.Modifier "bpy.types.Modifier"), (never None)) – Modifier to remove
