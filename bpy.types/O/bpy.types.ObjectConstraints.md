...
_class _bpy.types.ObjectConstraints(_bpy_struct_)
...
[`Constraint`](bpy.types.Constraint.html#bpy.types.Constraint "bpy.types.Constraint")
...
**type** (enum in [Constraint Type Items](bpy_types_enum_items/constraint_type_items.html#rna-enum-constraint-type-items)) – Constraint type to add
...
**constraint** ([`Constraint`](bpy.types.Constraint.html#bpy.types.Constraint "bpy.types.Constraint"), (never None)) – Removed constraint
...
**constraint** ([`Constraint`](bpy.types.Constraint.html#bpy.types.Constraint "bpy.types.Constraint"), (never None)) – Constraint to copy - may belong to a different object
