...
**constraint** ([`Constraint`](bpy.types.Constraint.md#bpy.types.Constraint "bpy.types.Constraint"), (never None)) – Removed constraint
...
**constraint** ([`Constraint`](bpy.types.Constraint.md#bpy.types.Constraint "bpy.types.Constraint"), (never None)) – Constraint to copy - may belong to a different object
