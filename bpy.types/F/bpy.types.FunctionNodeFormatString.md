...
base classes — [`bpy_struct`](../_other/bpy.types.bpy_struct.md#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`Node`](../N/bpy.types.Node.md#bpy.types.Node "bpy.types.Node"), [`NodeInternal`](../N/bpy.types.NodeInternal.md#bpy.types.NodeInternal "bpy.types.NodeInternal"), [`FunctionNode`](bpy.types.FunctionNode.md#bpy.types.FunctionNode "bpy.types.FunctionNode")
...
[`NodeFunctionFormatStringItems`](../N/bpy.types.NodeFunctionFormatStringItems.md#bpy.types.NodeFunctionFormatStringItems "bpy.types.NodeFunctionFormatStringItems") [`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeFunctionFormatStringItem`](../N/bpy.types.NodeFunctionFormatStringItem.md#bpy.types.NodeFunctionFormatStringItem "bpy.types.NodeFunctionFormatStringItem"), (readonly)
...
| 
  ...
  * [`FunctionNode.bl_rna_get_subclass`](bpy.types.FunctionNode.md#bpy.types.FunctionNode.bl_rna_get_subclass "bpy.types.FunctionNode.bl_rna_get_subclass")
  * [`FunctionNode.bl_rna_get_subclass_py`](bpy.types.FunctionNode.md#bpy.types.FunctionNode.bl_rna_get_subclass_py "bpy.types.FunctionNode.bl_rna_get_subclass_py")
