...
base classes — [`bpy_struct`](bpy.types.bpy_struct.html#bpy.types.bpy_struct "bpy.types.bpy_struct"), [`Node`](bpy.types.Node.html#bpy.types.Node "bpy.types.Node"), [`NodeInternal`](bpy.types.NodeInternal.html#bpy.types.NodeInternal "bpy.types.NodeInternal"), [`FunctionNode`](bpy.types.FunctionNode.html#bpy.types.FunctionNode "bpy.types.FunctionNode")

_class _bpy.types.FunctionNodeFormatString(_FunctionNode_)
...
[`NodeFunctionFormatStringItems`](bpy.types.NodeFunctionFormatStringItems.html#bpy.types.NodeFunctionFormatStringItems "bpy.types.NodeFunctionFormatStringItems") [`bpy_prop_collection`](bpy.types.bpy_prop_collection.html#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeFunctionFormatStringItem`](bpy.types.NodeFunctionFormatStringItem.html#bpy.types.NodeFunctionFormatStringItem "bpy.types.NodeFunctionFormatStringItem"), (readonly)
...
| 
  ...
  * [`FunctionNode.bl_rna_get_subclass`](bpy.types.FunctionNode.html#bpy.types.FunctionNode.bl_rna_get_subclass "bpy.types.FunctionNode.bl_rna_get_subclass")
  * [`FunctionNode.bl_rna_get_subclass_py`](bpy.types.FunctionNode.html#bpy.types.FunctionNode.bl_rna_get_subclass_py "bpy.types.FunctionNode.bl_rna_get_subclass_py")
