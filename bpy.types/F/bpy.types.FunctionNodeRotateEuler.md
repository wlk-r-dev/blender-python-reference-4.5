...
_class _bpy.types.FunctionNodeRotateEuler(_FunctionNode_)
...
Method used to describe the rotation
  ...
  * `EULER` Euler – Rotate around the X, Y, and Z axes.
...
Base orientation for rotation
  ...
  * `LOCAL` Local – Rotate the input rotation in its local space.
