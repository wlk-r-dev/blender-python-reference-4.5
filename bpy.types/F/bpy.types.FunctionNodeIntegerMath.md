...
_class _bpy.types.FunctionNodeIntegerMath(_FunctionNode_)
...
enum in [Node Integer Math Items](bpy_types_enum_items/node_integer_math_items.html#rna-enum-node-integer-math-items), default `'ADD'`
