...
**frame** (_float in_ _[__-inf_ _,__inf_ _]_) – Frame to add this control-point
...
[`FModifierEnvelopeControlPoint`](bpy.types.FModifierEnvelopeControlPoint.md#bpy.types.FModifierEnvelopeControlPoint "bpy.types.FModifierEnvelopeControlPoint")
...
**point** ([`FModifierEnvelopeControlPoint`](bpy.types.FModifierEnvelopeControlPoint.md#bpy.types.FModifierEnvelopeControlPoint "bpy.types.FModifierEnvelopeControlPoint"), (never None)) – Control-point to remove
...
## References
  ...
  * [`FModifierEnvelope.control_points`](bpy.types.FModifierEnvelope.md#bpy.types.FModifierEnvelope.control_points "bpy.types.FModifierEnvelope.control_points")
