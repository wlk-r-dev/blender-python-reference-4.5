...
## References
  ...
  * [`Linesets.active`](bpy.types.Linesets.md#bpy.types.Linesets.active "bpy.types.Linesets.active")
  * [`Linesets.new`](bpy.types.Linesets.md#bpy.types.Linesets.new "bpy.types.Linesets.new")

| 

  * [`Linesets.remove`](bpy.types.Linesets.md#bpy.types.Linesets.remove "bpy.types.Linesets.remove")
