...
_class _bpy.types.FunctionNodeHashValue(_FunctionNode_)
...
enum in [Node Socket Data Type Items](bpy_types_enum_items/node_socket_data_type_items.html#rna-enum-node-socket-data-type-items), default `'INT'`
