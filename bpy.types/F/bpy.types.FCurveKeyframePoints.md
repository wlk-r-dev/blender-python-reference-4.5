...
[`Keyframe`](../K/bpy.types.Keyframe.md#bpy.types.Keyframe "bpy.types.Keyframe")
...
Parameters:
  ...
  * **keyframe** ([`Keyframe`](../K/bpy.types.Keyframe.md#bpy.types.Keyframe "bpy.types.Keyframe"), (never None)) – Keyframe to remove
