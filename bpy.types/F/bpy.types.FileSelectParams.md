...
subclasses — [`FileAssetSelectParams`](bpy.types.FileAssetSelectParams.html#bpy.types.FileAssetSelectParams "bpy.types.FileAssetSelectParams")
...
[`FileSelectIDFilter`](bpy.types.FileSelectIDFilter.html#bpy.types.FileSelectIDFilter "bpy.types.FileSelectIDFilter"), (readonly, never None)
...
enum in [Fileselect Params Sort Items](bpy_types_enum_items/fileselect_params_sort_items.html#rna-enum-fileselect-params-sort-items), default `'FILE_SORT_ALPHA'`
