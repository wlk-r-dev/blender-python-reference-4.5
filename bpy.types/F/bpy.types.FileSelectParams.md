...
subclasses — [`FileAssetSelectParams`](bpy.types.FileAssetSelectParams.md#bpy.types.FileAssetSelectParams "bpy.types.FileAssetSelectParams")
...
[`FileSelectIDFilter`](bpy.types.FileSelectIDFilter.md#bpy.types.FileSelectIDFilter "bpy.types.FileSelectIDFilter"), (readonly, never None)
...
## References
  ...
  * [`SpaceFileBrowser.params`](../S/bpy.types.SpaceFileBrowser.md#bpy.types.SpaceFileBrowser.params "bpy.types.SpaceFileBrowser.params")

| 

  * [`UILayout.template_file_select_path`](../U/bpy.types.UILayout.md#bpy.types.UILayout.template_file_select_path "bpy.types.UILayout.template_file_select_path")
