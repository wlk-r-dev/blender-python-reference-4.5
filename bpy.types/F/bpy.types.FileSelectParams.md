...
## References
  ...
  * [`SpaceFileBrowser.params`](bpy.types.SpaceFileBrowser.md#bpy.types.SpaceFileBrowser.params "bpy.types.SpaceFileBrowser.params")

| 

  * [`UILayout.template_file_select_path`](bpy.types.UILayout.md#bpy.types.UILayout.template_file_select_path "bpy.types.UILayout.template_file_select_path")
