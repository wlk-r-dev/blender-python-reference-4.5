...
_class _bpy.types.FunctionNodeBooleanMath(_FunctionNode_)
...
enum in [Node Boolean Math Items](bpy_types_enum_items/node_boolean_math_items.html#rna-enum-node-boolean-math-items), default `'AND'`
