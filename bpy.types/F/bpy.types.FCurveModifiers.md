...
**type** (enum in [Fmodifier Type Items](bpy_types_enum_items/fmodifier_type_items.md#rna-enum-fmodifier-type-items)) – Constraint type to add
...
**modifier** ([`FModifier`](bpy.types.FModifier.md#bpy.types.FModifier "bpy.types.FModifier"), (never None)) – Removed modifier
