...
_class _bpy.types.FunctionNodeCompare(_FunctionNode_)
...
mode
  ...
  * `DIRECTION` Direction – Compare the direction of the input vectors.
...
enum in [Node Compare Operation Items](bpy_types_enum_items/node_compare_operation_items.html#rna-enum-node-compare-operation-items), default `'EQUAL'`
