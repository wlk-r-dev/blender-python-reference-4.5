...
_class _bpy.types.FunctionNodeFloatToInt(_FunctionNode_)
...
enum in [Node Float To Int Items](bpy_types_enum_items/node_float_to_int_items.html#rna-enum-node-float-to-int-items), default `'ROUND'`
