...
_class _bpy.types.FunctionNodeSeparateColor(_FunctionNode_)
...
enum in [Node Combsep Color Items](bpy_types_enum_items/node_combsep_color_items.html#rna-enum-node-combsep-color-items), default `'RGB'`
