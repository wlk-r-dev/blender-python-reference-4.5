...
_class _bpy.types.Palette(_ID_)
...
[`PaletteColors`](bpy.types.PaletteColors.md#bpy.types.PaletteColors "bpy.types.PaletteColors") [`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`PaletteColor`](bpy.types.PaletteColor.md#bpy.types.PaletteColor "bpy.types.PaletteColor"), (readonly)
...
## References
  ...
  * [`BlendData.palettes`](../B/bpy.types.BlendData.md#bpy.types.BlendData.palettes "bpy.types.BlendData.palettes")
  * [`BlendDataPalettes.new`](../B/bpy.types.BlendDataPalettes.md#bpy.types.BlendDataPalettes.new "bpy.types.BlendDataPalettes.new")

| 

  * [`BlendDataPalettes.remove`](../B/bpy.types.BlendDataPalettes.md#bpy.types.BlendDataPalettes.remove "bpy.types.BlendDataPalettes.remove")
