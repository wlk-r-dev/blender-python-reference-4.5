...
## References
  ...
  * [`Palette.colors`](bpy.types.Palette.md#bpy.types.Palette.colors "bpy.types.Palette.colors")
  * [`PaletteColors.active`](bpy.types.PaletteColors.md#bpy.types.PaletteColors.active "bpy.types.PaletteColors.active")

| 

  * [`PaletteColors.new`](bpy.types.PaletteColors.md#bpy.types.PaletteColors.new "bpy.types.PaletteColors.new")
  * [`PaletteColors.remove`](bpy.types.PaletteColors.md#bpy.types.PaletteColors.remove "bpy.types.PaletteColors.remove")
