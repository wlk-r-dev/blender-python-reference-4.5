...
[`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`PoseBone`](bpy.types.PoseBone.md#bpy.types.PoseBone "bpy.types.PoseBone"), (readonly)
...
[`IKParam`](../I/bpy.types.IKParam.md#bpy.types.IKParam "bpy.types.IKParam"), (readonly)
...
Parameters:
  ...
  * **action** ([`Action`](../A/bpy.types.Action.md#bpy.types.Action "bpy.types.Action")) – Action, The Action containing the pose
...
**action** ([`Action`](../A/bpy.types.Action.md#bpy.types.Action "bpy.types.Action")) – Action, An Action with animation data for the bones. Only the animated bones will be included in the backup.
...
## References
  ...
  * [`Object.pose`](../O/bpy.types.Object.md#bpy.types.Object.pose "bpy.types.Object.pose")
