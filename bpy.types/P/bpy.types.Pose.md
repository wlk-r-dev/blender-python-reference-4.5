...
[`bpy_prop_collection`](bpy.types.bpy_prop_collection.html#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`PoseBone`](bpy.types.PoseBone.html#bpy.types.PoseBone "bpy.types.PoseBone"), (readonly)
...
[`IKParam`](bpy.types.IKParam.html#bpy.types.IKParam "bpy.types.IKParam"), (readonly)
...
Parameters:
  ...
  * **action** ([`Action`](bpy.types.Action.html#bpy.types.Action "bpy.types.Action")) – Action, The Action containing the pose
...
**action** ([`Action`](bpy.types.Action.html#bpy.types.Action "bpy.types.Action")) – Action, An Action with animation data for the bones. Only the animated bones will be included in the backup.
...
## References
  ...
  * [`Object.pose`](bpy.types.Object.html#bpy.types.Object.pose "bpy.types.Object.pose")
