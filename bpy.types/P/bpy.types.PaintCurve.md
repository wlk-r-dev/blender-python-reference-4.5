...
_class _bpy.types.PaintCurve(_ID_)
...
## References
  ...
  * [`BlendData.paint_curves`](../B/bpy.types.BlendData.md#bpy.types.BlendData.paint_curves "bpy.types.BlendData.paint_curves")

| 

  * [`Brush.paint_curve`](../B/bpy.types.Brush.md#bpy.types.Brush.paint_curve "bpy.types.Brush.paint_curve")
