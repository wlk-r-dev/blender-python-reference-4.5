...
enum in [Navigation Mode Items](bpy_types_enum_items/navigation_mode_items.html#rna-enum-navigation-mode-items), default `'WALK'`
...
[`WalkNavigation`](bpy.types.WalkNavigation.html#bpy.types.WalkNavigation "bpy.types.WalkNavigation"), (readonly, never None)
...
## References
  ...
  * [`Preferences.inputs`](bpy.types.Preferences.html#bpy.types.Preferences.inputs "bpy.types.Preferences.inputs")
