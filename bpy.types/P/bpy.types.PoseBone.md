...
[`Bone`](bpy.types.Bone.html#bpy.types.Bone "bpy.types.Bone"), (readonly, never None)
...
[`BoneColor`](bpy.types.BoneColor.html#bpy.types.BoneColor "bpy.types.BoneColor"), (readonly)
...
[`PoseBoneConstraints`](bpy.types.PoseBoneConstraints.html#bpy.types.PoseBoneConstraints "bpy.types.PoseBoneConstraints") [`bpy_prop_collection`](bpy.types.bpy_prop_collection.html#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`Constraint`](bpy.types.Constraint.html#bpy.types.Constraint "bpy.types.Constraint"), (readonly)
...
enum in [Object Rotation Mode Items](bpy_types_enum_items/object_rotation_mode_items.html#rna-enum-object-rotation-mode-items), default `'QUATERNION'`
...
**point** ([`mathutils.Vector`](mathutils.html#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf]) – Point, Position in 3d space to evaluate
...
**point** ([`mathutils.Vector`](mathutils.html#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf]) – Point, Vertex position in armature pose space
...
handle1, The direction vector of the start handle in bone local space, [`mathutils.Vector`](mathutils.html#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf]

roll1, Roll of the start handle, float in [-inf, inf]

handle2, The direction vector of the end handle in bone local space, [`mathutils.Vector`](mathutils.html#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf]
...
([`mathutils.Vector`](mathutils.html#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], float in [-inf, inf], [`mathutils.Vector`](mathutils.html#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf], float in [-inf, inf])
...
## References
  ...
  * [`bpy.context.active_pose_bone`](bpy.context.html#bpy.context.active_pose_bone "bpy.context.active_pose_bone")
  * [`bpy.context.pose_bone`](bpy.context.html#bpy.context.pose_bone "bpy.context.pose_bone")
  * [`bpy.context.selected_pose_bones`](bpy.context.html#bpy.context.selected_pose_bones "bpy.context.selected_pose_bones")
  * [`bpy.context.selected_pose_bones_from_active_object`](bpy.context.html#bpy.context.selected_pose_bones_from_active_object "bpy.context.selected_pose_bones_from_active_object")
  * [`bpy.context.visible_pose_bones`](bpy.context.html#bpy.context.visible_pose_bones "bpy.context.visible_pose_bones")
  * [`Object.convert_space`](bpy.types.Object.html#bpy.types.Object.convert_space "bpy.types.Object.convert_space")

| 

  * [`Pose.bones`](bpy.types.Pose.html#bpy.types.Pose.bones "bpy.types.Pose.bones")
