...
enum in [Fcurve Auto Smoothing Items](bpy_types_enum_items/fcurve_auto_smoothing_items.html#rna-enum-fcurve-auto-smoothing-items), default `'CONT_ACCEL'`
...
enum in [Keyframe Handle Type Items](bpy_types_enum_items/keyframe_handle_type_items.html#rna-enum-keyframe-handle-type-items), default `'AUTO_CLAMPED'`
...
enum in [Beztriple Interpolation Mode Items](bpy_types_enum_items/beztriple_interpolation_mode_items.html#rna-enum-beztriple-interpolation-mode-items), default `'BEZIER'`
...
## References
  ...
  * [`Preferences.edit`](bpy.types.Preferences.html#bpy.types.Preferences.edit "bpy.types.Preferences.edit")
