...
subclasses — [`BoolProperty`](bpy.types.BoolProperty.md#bpy.types.BoolProperty "bpy.types.BoolProperty"), [`CollectionProperty`](bpy.types.CollectionProperty.md#bpy.types.CollectionProperty "bpy.types.CollectionProperty"), [`EnumProperty`](bpy.types.EnumProperty.md#bpy.types.EnumProperty "bpy.types.EnumProperty"), [`FloatProperty`](bpy.types.FloatProperty.md#bpy.types.FloatProperty "bpy.types.FloatProperty"), [`IntProperty`](bpy.types.IntProperty.md#bpy.types.IntProperty "bpy.types.IntProperty"), [`PointerProperty`](bpy.types.PointerProperty.md#bpy.types.PointerProperty "bpy.types.PointerProperty"), [`StringProperty`](bpy.types.StringProperty.md#bpy.types.StringProperty "bpy.types.StringProperty")
...
[`Struct`](bpy.types.Struct.md#bpy.types.Struct "bpy.types.Struct"), (readonly)
...
## References
  ...
  * [`Function.parameters`](bpy.types.Function.md#bpy.types.Function.parameters "bpy.types.Function.parameters")

| 

  * [`Struct.properties`](bpy.types.Struct.md#bpy.types.Struct.properties "bpy.types.Struct.properties")
