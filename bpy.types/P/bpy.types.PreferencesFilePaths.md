...
[`AssetLibraryCollection`](../A/bpy.types.AssetLibraryCollection.md#bpy.types.AssetLibraryCollection "bpy.types.AssetLibraryCollection") [`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`UserAssetLibrary`](../U/bpy.types.UserAssetLibrary.md#bpy.types.UserAssetLibrary "bpy.types.UserAssetLibrary"), (readonly)
...
[`ScriptDirectoryCollection`](../S/bpy.types.ScriptDirectoryCollection.md#bpy.types.ScriptDirectoryCollection "bpy.types.ScriptDirectoryCollection") [`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`ScriptDirectory`](../S/bpy.types.ScriptDirectory.md#bpy.types.ScriptDirectory "bpy.types.ScriptDirectory"), (readonly)
