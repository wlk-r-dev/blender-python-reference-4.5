...
A mix-in parent class can be used to share common properties and [`Menu.poll`](bpy.types.Menu.md#bpy.types.Menu.poll "bpy.types.Menu.poll") function.
...
[`Constraint`](bpy.types.Constraint.md#bpy.types.Constraint "bpy.types.Constraint"), (readonly)
