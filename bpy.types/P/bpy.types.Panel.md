...
A mix-in parent class can be used to share common properties and [`Menu.poll`](bpy.types.Menu.html#bpy.types.Menu.poll "bpy.types.Menu.poll") function.
...
[`Constraint`](bpy.types.Constraint.html#bpy.types.Constraint "bpy.types.Constraint"), (readonly)
