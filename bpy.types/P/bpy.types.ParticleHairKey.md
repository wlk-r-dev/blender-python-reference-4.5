...
Parameters:
  ...
  * **modifier** ([`ParticleSystemModifier`](bpy.types.ParticleSystemModifier.html#bpy.types.ParticleSystemModifier "bpy.types.ParticleSystemModifier"), (never None)) – Particle modifier

  * **particle** ([`Particle`](bpy.types.Particle.html#bpy.types.Particle "bpy.types.Particle"), (never None)) – hair particle
...
Parameters:
  ...
  * **co** ([`mathutils.Vector`](mathutils.html#mathutils.Vector "mathutils.Vector") of 3 items in [-inf, inf]) – Co, Specified hairkey location
...
## References
  ...
  * [`Particle.hair_keys`](bpy.types.Particle.html#bpy.types.Particle.hair_keys "bpy.types.Particle.hair_keys")
