...
subclasses — [`Itasc`](bpy.types.Itasc.html#bpy.types.Itasc "bpy.types.Itasc")

_class _bpy.types.IKParam(_bpy_struct_)
...
## References
  ...
  * [`Pose.ik_param`](bpy.types.Pose.html#bpy.types.Pose.ik_param "bpy.types.Pose.ik_param")
