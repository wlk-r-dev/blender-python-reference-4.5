...
## References
  ...
  * [`MovieClip.metadata`](bpy.types.MovieClip.md#bpy.types.MovieClip.metadata "bpy.types.MovieClip.metadata")

| 

  * [`MovieStrip.metadata`](bpy.types.MovieStrip.md#bpy.types.MovieStrip.metadata "bpy.types.MovieStrip.metadata")
