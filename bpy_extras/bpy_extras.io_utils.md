...
Function to ensure an operator has valid axis conversion settings, intended to be used from [`bpy.types.Operator.check`](bpy.types.Operator.html#bpy.types.Operator.check "bpy.types.Operator.check").

Parameters:
    

  * **operator** ([`bpy.types.Operator`](bpy.types.Operator.html#bpy.types.Operator "bpy.types.Operator")) – the operator to access axis attributes from.
...
Parameters:
  ...
  * **depsgraph** ([`bpy.types.Depsgraph`](bpy.types.Depsgraph.html#bpy.types.Depsgraph "bpy.types.Depsgraph")) – The evaluated depsgraph.

  * **objects** (Sequence[[`bpy.types.Object`](bpy.types.Object.html#bpy.types.Object "bpy.types.Object")]) – A sequencer of objects.
...
dict[[`bpy.types.Object`](bpy.types.Object.html#bpy.types.Object "bpy.types.Object"), list[tuple[[`bpy.types.Object`](bpy.types.Object.html#bpy.types.Object "bpy.types.Object"), [`mathutils.Matrix`](mathutils.html#mathutils.Matrix "mathutils.Matrix")]]]
...
Parameters:
  ...
  * **library** ([`bpy.types.Library`](bpy.types.Library.html#bpy.types.Library "bpy.types.Library") | None) – The library this path is relative to.
