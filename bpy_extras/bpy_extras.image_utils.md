...
Parameters:
  ...
  * **check_existing** (_bool_) – If true, returns already loaded image datablock if possible (based on file path).
...
[`bpy.types.Image`](bpy.types.Image.html#bpy.types.Image "bpy.types.Image") | None
