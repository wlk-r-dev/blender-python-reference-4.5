...
Parameters:
  ...
  * **region** ([`bpy.types.Region`](bpy.types.Region.html#bpy.types.Region "bpy.types.Region")) – region of the 3D viewport, typically bpy.context.region.

  * **rv3d** ([`bpy.types.RegionView3D`](bpy.types.RegionView3D.html#bpy.types.RegionView3D "bpy.types.RegionView3D")) – 3D region data, typically bpy.context.space_data.region_3d.
...
[`mathutils.Vector`](mathutils.html#mathutils.Vector "mathutils.Vector") | Any
