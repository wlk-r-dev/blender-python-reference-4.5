...
Parameters:
  ...
  * **rv3d** ([`bpy.types.RegionView3D`](bpy.types.RegionView3D.md#bpy.types.RegionView3D "bpy.types.RegionView3D")) – 3D region data, typically bpy.context.space_data.region_3d.
