...
Parameters:
  ...
  * **action** ([`bpy.types.Action`](bpy.types.Action.md#bpy.types.Action "bpy.types.Action") | None) – An action to bake the data into, or None for a new action to be created.
...
Parameters:
  ...
  * **object_action_pairs** (Sequence of ([`bpy.types.Object`](bpy.types.Object.md#bpy.types.Object "bpy.types.Object"), [`bpy.types.Action`](bpy.types.Action.md#bpy.types.Action "bpy.types.Action"))) – Sequence of object action tuples, action is the destination for the baked data. When None a new action will be created.
