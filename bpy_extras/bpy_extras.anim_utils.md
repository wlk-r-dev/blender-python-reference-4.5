...
Parameters:
  ...
  * **obj** ([`bpy.types.Object`](bpy.types.Object.html#bpy.types.Object "bpy.types.Object")) – Object to bake.

  * **action** ([`bpy.types.Action`](bpy.types.Action.html#bpy.types.Action "bpy.types.Action") | None) – An action to bake the data into, or None for a new action to be created.
...
[`bpy.types.Action`](bpy.types.Action.html#bpy.types.Action "bpy.types.Action") | None
...
Sequence[[`bpy.types.Action`](bpy.types.Action.html#bpy.types.Action "bpy.types.Action")]
...
Parameters:
  ...
  * **object_action_pairs** (Sequence of ([`bpy.types.Object`](bpy.types.Object.html#bpy.types.Object "bpy.types.Object"), [`bpy.types.Action`](bpy.types.Action.html#bpy.types.Action "bpy.types.Action"))) – Sequence of object action tuples, action is the destination for the baked data. When None a new action will be created.
