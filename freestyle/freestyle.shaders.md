...
**texture** ([`bpy.types.LineStyleTextureSlot`](bpy.types.LineStyleTextureSlot.html#bpy.types.LineStyleTextureSlot "bpy.types.LineStyleTextureSlot") or [`bpy.types.ShaderNodeTree`](bpy.types.ShaderNodeTree.html#bpy.types.ShaderNodeTree "bpy.types.ShaderNodeTree")) – A line style texture slot or a shader node tree to define a set of textures.
...
Parameters:
  ...
  * **orientation** ([`mathutils.Vector`](mathutils.html#mathutils.Vector "mathutils.Vector")) – The 2D vector giving the main direction.
