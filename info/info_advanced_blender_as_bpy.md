...
The attribute [`bpy.app.binary_path`](bpy.app.html#bpy.app.binary_path "bpy.app.binary_path") defaults to an empty string.
...
There are many modules included with Blender such as [`gpu`](gpu.html#module-gpu "gpu") and `mathuils`. It’s important that these are imported after `bpy` or they will not be found.
