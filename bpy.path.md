...
Parameters:
  ...
  * **library** ([`bpy.types.Library`](bpy.types.Library.html#bpy.types.Library "bpy.types.Library")) – The library this path is from. This is only included for convenience, when the library is not None its path replaces _start_.
