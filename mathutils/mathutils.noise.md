...
**position** ([`mathutils.Vector`](mathutils.html#mathutils.Vector "mathutils.Vector")) – The position to evaluate the selected noise function.
...
list[list[float] | list[[`mathutils.Vector`](mathutils.html#mathutils.Vector "mathutils.Vector")]]
