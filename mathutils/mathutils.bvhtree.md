...
_classmethod _FromBMesh(_bmesh_ , _epsilon =0.0_)
...
_classmethod _FromObject(_object_ , _depsgraph_ , _deform =True_, _render =False_, _cage =False_, _epsilon =0.0_)
...
_classmethod _FromPolygons(_vertices_ , _polygons_ , _all_triangles =False_, _epsilon =0.0_)
...
find_nearest(_origin_ , _distance =1.84467e+19_)
...
find_nearest_range(_origin_ , _distance =1.84467e+19_)
...
ray_cast(_origin_ , _direction_ , _distance =sys.float_info.max_)
